 ...
 */
public class AddResourceCareerAdvancementFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceCareerAdvancementFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesCareerAdvancementFragments();
                    case 1:
                        return new ArchivedCareerAdvancementFragment();
                    case 2:
                        return new DeactivatedCareerAdvancementFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
