...
public class BlogsAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    private ArrayList<BlogsObject> list;
    private NetworkConnectivity networkConnectivity;
    private UtilitiesClass utilitiesClass;
    //private static int pos = 0;

    public BlogsAdapter(Context context, ArrayList<BlogsObject> list, String fragmentName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final HomeFeedsAdapter.ViewHolder holder;
        convertView1 = convertView;
        final ArrayList<String> files = new ArrayList<>();
        if (convertView == null) {
            convertView = l_Inflater.inflate(R.layout.blog_item, null);
            holder = new HomeFeedsAdapter.ViewHolder();
            ...
            holder = (HomeFeedsAdapter.ViewHolder) convertView.getTag();
        }
        try {

            holder.fundTitle.setText(list.get(position).getBlogName());

            holder.tv_postedDate.setText(list.get(position).getBolgDate());

            holder.fundDescription.setText(list.get(position).getBlogDesc()+ " "+"More..");
