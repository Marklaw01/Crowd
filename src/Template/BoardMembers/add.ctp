          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Add Board Member</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Board Membership Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Board Membership Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Board Membership Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Board Membership Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Board Membership Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Board Membership Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Board Membership End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Board Membership End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Board Membership Keywords</label>
                <?php
                  //echo $this->Form->input('board_oppertunity_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'board_oppertunity_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Board Membership Keywords Added", 'options'=>$keywordsLists));
                ?> 
              ...
              <label>Interest Keywords</label>
                <?php
                  //echo $this->Form->input('board_interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'board_interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added", 'options'=>$intrestKeywordLists));
                ?> 
