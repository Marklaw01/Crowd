...
public class AudioVideoFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity)getActivity()).setActionBarTitle(getString(R.string.audioVideo));
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new SearchResourcesAudioVideoFragment();
                    case 1:
                        return new AddResourceAudioVideoFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return "Search Audio/Video";
                case 1:
                    return "Add Audio/Video";
            }
            return null;
        }
    }
