 ...
 */
public class DeactivatedDemoDaysAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedDemoDaysAdapter(Context context, ArrayList<FundsObject> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this event?", Constants.DEMODAYS_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
