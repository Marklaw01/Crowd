...
#define SOFTWARE_FOLLOW_SECTION_INDEX           0
#define SOFTWARE_TITLE_SECTION_INDEX           1
#define SOFTWARE_DESCRIPTION_SECTION_INDEX  2
#define SOFTWARE_START_DATE_SECTION_INDEX  3
#define SOFTWARE_END_DATE_SECTION_INDEX    4
#define SOFTWARE_TARGET_MARKET_KEYWORDS_SECTION_INDEX    5
#define SOFTWARE_KEYWORDS_SECTION_INDEX    6
#define SOFTWARE_INDUSTRY_KEYWORDS_SECTION_INDEX  7
#define SOFTWARE_IMAGE_SECTION_INDEX       8
#define SOFTWARE_DOCUMENT_SECTION_INDEX    9
#define SOFTWARE_AUDIO_SECTION_INDEX       10
#define SOFTWARE_VIDEO_SECTION_INDEX       11
...
enum {
    SOFTWARE_TARGET_MARKET_KEYWORDS_SELECTED = 5,
    SOFTWARE_KEYWORDS_SELECTED = 6,
    SOFTWARE_INDUSTRY_KEYWORDS_SELECTED = 7
};
...
#define kEditSoftware_SuccessMessage           @"Software has been updated Successfully."
...
@interface EditSoftwareViewController : UIViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate, TLTagsControlDelegate, UISearchBarDelegate>
{
    // --- IBOutlets ---
    ...
    IBOutlet UIView                           *softwareDataView;
