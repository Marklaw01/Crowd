                          ...
                          <li>
                           ...
                           <div class="listingContent">
                            ...
                            <div class="links alignRight">
                              ...
                              ?>
                              <?php 
                                 echo $this->Form->postLink('Archive',['action' => 'deactivateJob', base64_encode($myJob->id)],['id'=>'deactPost'.$c,'class'=>'smallCurveBtnJobs orangeBtn customBtn ','title'=>'Deactivate']);
                              ?>
                              <?php 
