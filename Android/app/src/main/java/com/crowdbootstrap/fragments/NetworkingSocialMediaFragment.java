...
public class NetworkingSocialMediaFragment extends Fragment implements onActivityResultListener, AsyncTaskCompleteListener<String> {


    private static final String host = "api.linkedin.com";
    private static final String url = "https://" + host
            + "/v1/people/~:" +
            "(email-address,formatted-name,phone-numbers,interests,public-profile-url,picture-url::(original))";
...
//    private static final String url = "https://" + host + "/v1/people/~:(first-name,last-name,email-address,formatted-name,phone-numbers,public-profile-url,picture-url,picture-urls::(original))";
    ...
    public NetworkingSocialMediaFragment() {
    ...
    public void onResume() {
        super.onResume();
        ((HomeActivity) getActivity()).setActionBarTitle("Connect Social Media");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        saveBusinessCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userImageURL = getByteArrayFromImageURL(bitmap);

                Log.e("xxxx", "IMAGE+++" + userImageURL);
    ...
    public void showResult(JSONObject response) {
        ...
        try {
            //userInterest.setText(response.get("interests").toString());
            username.setText(response.get("formattedName").toString());
            userBio.setText(response.get("publicProfileUrl").toString());


            userImageURL = response.getString("pictureUrl");
            ...
            ImageLoader.getInstance().displayImage(userImageURL, userImage, options);
    ...
    private String getByteArrayFromImageURL(Bitmap btmap) {

        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            btmap.compress(Bitmap.CompressFormat.PNG, 10, byteArrayOutputStream);
        ...
        LISessionManager.getInstance(getActivity())
                .init(getActivity(), buildScope(), new AuthListener() {
                    ...
                    public void onAuthSuccess() {
                        ...
                        Log.e("XXX", "VALUES++++" + LISessionManager
    ...
    public void generateHashkey() {
        try {
            PackageInfo info = getActivity().getPackageManager().getPackageInfo(
                    String.valueOf("com.crowdbootstrap"),
            ...
            for (Signature signature : info.signatures) {
                ...
                String str = Base64.encodeToString(md.digest(),
                        Base64.NO_WRAP);
                Log.e("XXXX", "GENERTATED_HASHKEY+++++" + str);
