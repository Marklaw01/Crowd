//
//  AddImprovementToolViewController.m
//  CrowdBootstrap
//
...
#import "AddImprovementToolViewController.h"
...
@interface AddImprovementToolViewController ()

@end

@implementation AddImprovementToolViewController
...
-(void)initializeSectionArray {
    ...
    NSArray *fieldsArray = @[@"Self Improvement Title", @"Self Improvement Description", @"Self Improvement Availability Start Date", @"Self Improvement Availability End Date", @"Target Market", @"Self Improvement Keywords", @"Interest Keywords", @"Upload Image"] ;
    NSArray *parametersArray = @[kImprovementToolAPI_Title, kImprovementToolAPI_Description, kImprovementToolAPI_StartDate, kImprovementToolAPI_EndDate, kAddImprovementToolAPI_Target_Market_Keywords, kAddImprovementToolAPI_Keywords, kAddImprovementToolAPI_IndustryKeywords, kImprovementToolAPI_Image] ;
    ...
    if ([type isEqualToString:@"targetmarket"]) {
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kImprovementToolAPI_Target_Market_ID] ;
        ...
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kImprovementToolAPI_KeywordID] ;
                if([selectedValue intValue] == [value intValue]){
        ...
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kImprovementToolAPI_Industry_ID] ;
                if([selectedValue intValue] == [value intValue]){
...
-(void)createImprovement {
    if([UtilityClass checkInternetConnection]) {
        ...
        [ApiCrowdBootstrap addImprovementWithParameters:dictParam success:^(NSDictionary *responseDict) {
            ...
            if([[responseDict valueForKey:@"code"] intValue] == kSuccessCode ) {
                ...
                [UtilityClass showNotificationMessgae:kAddImprovementTool_SuccessMessage withResultType:@"0" withDuration:1] ;
