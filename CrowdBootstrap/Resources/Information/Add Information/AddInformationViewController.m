...
-(void)initializeSectionArray {
    ...
    NSArray *fieldsArray = @[@"Information Title", @"Information Description", @"Information Availability Start Date", @"Information Availability End Date", @"Target Market", @"Information Keywords", @"Interest Keywords", @"Upload Image"] ;
    NSArray *parametersArray = @[kInformationAPI_Title, kInformationAPI_Description, kInformationAPI_StartDate, kInformationAPI_EndDate, kAddInformationAPI_Target_Market_Keywords, kAddInformationAPI_Keywords, kAddInformationAPI_IndustryKeywords, kInformationAPI_Image] ;
    ...
    if ([type isEqualToString:@"targetmarket"]) {
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kInformationAPI_Target_Market_ID] ;
        ...
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kInformationAPI_KeywordID] ;
                if([selectedValue intValue] == [value intValue]){
        ...
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kInformationAPI_Industry_ID] ;
                if([selectedValue intValue] == [value intValue]){
...
-(void)createInformation {
    if([UtilityClass checkInternetConnection]) {
        ...
        [ApiCrowdBootstrap addInformationWithParameters:dictParam success:^(NSDictionary *responseDict) {
            ...
            if([[responseDict valueForKey:@"code"] intValue] == kSuccessCode ) {
                ...
                [UtilityClass showNotificationMessgae:kAddInformation_SuccessMessage withResultType:@"0" withDuration:1] ;
