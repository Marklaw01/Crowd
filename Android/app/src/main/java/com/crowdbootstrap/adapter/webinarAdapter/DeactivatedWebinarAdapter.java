 ...
 */
public class DeactivatedWebinarAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedWebinarAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        try {
           ...
           // holder.dislikeBtn.setOnClickListener(this);
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this event?", Constants.WEBINAR_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
