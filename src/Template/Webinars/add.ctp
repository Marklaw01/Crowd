          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Webinar Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Webinar Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Webinar Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Webinar Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Webinar Availability Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Webinar Availability Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Webinar Availability End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Webinar Availability End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
