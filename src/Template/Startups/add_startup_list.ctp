          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li> <?php
                    echo $this->Html->link('My Profile', array('controller'=>'Startups','action'=>'listStartup'), array('escape'=>false));
                ?></li>
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-6 ">
                            <div class="profileName">
                              <?php
                                  ...
                                  echo $this->Html->link('BACK', array('controller'=>'Startups','action'=>'listStartup'), array('escape'=>false,'class'=>'active'));
                              ?>
                            </div>  
                         </div>   
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                            ...
                            <div class="checkbox">
                                  <?php foreach($startupdata as $startup){ 
                                    if(in_array($startup['startup']['id'], $selectedStartup)){ $checked= 'checked="checked"';}else { $checked='';}
                                  ?>
                                        <div class="form-group">
                                          <input type="checkbox" name="startup_id[]" <?php echo $checked;?> class="checkinput" id="startup_id_<?= $startup['startup']['id'] ?>" value="<?= $startup['startup']['id'] ?>"> 

                                          <label for="startup_id_<?= $startup['startup']['id'] ?>"><?= $startup['startup']['name'] ?></label> 
                                        </div>
                                  <?php $i++; } // Foreach close ?> 
                            </div>
