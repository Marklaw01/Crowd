          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li> <?php
                    echo $this->Html->link('Board Members', array('controller'=>'BoardMembers','action'=>'myBoardMember'), array('escape'=>false));
                ?></li>
                <li class="active">Search Recommended Board Members</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          <div class='row'>
            <div class='col-lg-12 col-md-12 col-sm-12 '>
             <div class="page_heading">
               <h1>Search Recommended Board Members</h1> 
              </div>
            </div>
