...
class FocusGroupUploadComponent extends Component
{
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('FocusGroupInterestKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('FocusGroupKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('FocusGroupTargetMarkets');
		...
		* * * * */
		public function isFollowedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('FocusGroupFollowers');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['focus_group_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function isCommitedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('FocusCommitments');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['focus_group_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function getCommitCount($fundId=null)
		{
			...
			$FundDislikes = TableRegistry::get('FocusCommitments');
			$likelists= $FundDislikes->find('all',['conditions'=>['focus_group_id' => $fundId]]);
	    ...
	    ****/
	    ...
	    public function uploadImage($files = null) 
	    {
		    ...
		    if(!empty($files)){
                ...
                $path = WWW_ROOT . "img/focus_group/"; // Upload directory
                $imgCamp='';
                $errors='';
