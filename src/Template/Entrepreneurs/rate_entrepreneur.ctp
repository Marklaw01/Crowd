          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active"><?php
                    echo $this->Html->link('Profile', array('controller'=>'Entrepreneurs','action'=>'viewProfile',$contractorId,$StartupId), array('escape'=>false));
                ?></li>
                <li class="active">Rate Entrepreneur</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              <div class="form-group">
                    <span class="form-control">
                        <?php echo $userName= $User->entrepreneur_basic->first_name.' '.$User->entrepreneur_basic->last_name;?>
                    </span>
              </div>
