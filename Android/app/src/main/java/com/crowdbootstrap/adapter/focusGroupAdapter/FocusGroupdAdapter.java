 ...
 */
public class FocusGroupdAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public FocusGroupdAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
