          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Add Beta Test</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Beta Test Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Beta Test Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Beta Test Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Beta Test Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Beta Test Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Beta Test Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Beta Test End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Beta Test End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Beta Test Keywords</label>
                <?php
                  //echo $this->Form->input('beta_test_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'beta_test_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Beta Test Keywords Added", 'options'=>$keywordsLists));
                ?> 
              ...
              <label>Interest Keywords</label>
                <?php
                  //echo $this->Form->input('beta_interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'beta_interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added", 'options'=>$intrestKeywordLists));
                ?> 
