 ...
 */
public class AddResourceConsultingFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 4;

    public AddResourceConsultingFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesConsultingFragments();
                    case 1:
                        return new ArchivedConsultingFragment();
                    case 2:
                        return new DeactivatedConsultingFragment();
                    case 3:
                        return new InvitationsConsultingFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
