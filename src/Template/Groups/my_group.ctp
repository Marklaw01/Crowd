    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND GROUP', array('controller'=>'Groups','action'=>'index'), array('escape'=>false,'class'=>'active '));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'MY GROUPS', array('controller'=>'Groups','action'=>'myGroup'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div role="tabpanel" class="campaigns-section">
        ...
        <ul id="tabbing" class="nav aboutTab nav-tabs hidden-xs" role="tablist">
          ...
          <?php $mycamp= $this->Url->build(["controller" => "Groups","action" => "myGroup"]);?>
          <a href="#myFund" aria-controls="My Groups" role="tab" data-toggle="tab" onclick="location.href='<?php echo $mycamp;?>'">My Groups</a></li>

          <li role="presentation">
          <?php $followi = $this->Url->build(["controller" => "Groups","action" => "myArchived"]);?>
          ...
          <li role="presentation">
          <?php $commit= $this->Url->build(["controller" => "Groups","action" => "myDeactivated"]);?>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane active whiteBg" id="myFund">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="form-group">
                  <?= $this->Html->link(__('Add Group'), ['action' => 'add'],['class'=>'customBtn blueBtn  pull-right']) ?>
                </div>
              </div>
                      ...
                      <li>
                       ...
                       <div class="listingContent">
                         <div class="headingBar">
                           ...
                           <h2 class="likes">
                            <?php echo $likeC = $this->Custom->getGroupLikeCount($myFundsList->id);?> 
                            
                            <?php 
                            if($this->Custom->isGroupLikedbyUser($myFundsList->id,$UserId)){
                            ...
                            <?php echo $disLikeC = $this->Custom->getGroupDislikeCount($myFundsList->id);?> 
                        
                            <?php 
                              if($this->Custom->isGroupDislikedbyUser($myFundsList->id,$UserId)){
