...
public class ViewOtherEntrepreneurPublicProfileFragment extends Fragment implements View.OnClickListener {
    ...
    public ViewOtherEntrepreneurPublicProfileFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        img_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transactionRate.replace(R.id.container, rateContributor).addToBackStack(ViewOtherEntrepreneurPublicProfileFragment.class.getName());
                //transactionRate.addToBackStack(null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.img_excellenceAward:
                ...
                //getFragmentManager().beginTransaction().replace(R.id.container, excellenceAward).addToBackStack(ViewOtherEntrepreneurPublicProfileFragment.class.getName()).commit();
                break;
        }
    }
