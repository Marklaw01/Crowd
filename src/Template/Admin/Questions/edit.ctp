<div id="page-content-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 ">
          <h1 class="page-header"><i class="fa fa-users"></i>Edit Question 
          </h1>
          <?php
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-8 col-sm-12 ">
                        ...
                        <label>Question Name</label>
                            <?php
                              echo $this->Form->input('name', ARRAY('label' => false, 'div' => false,'error' => false, 'class' => 'form-control','placeholder'=>'Question Name'));
                           ?>
                           <?php 
