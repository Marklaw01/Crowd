<div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li> <?php
                    echo $this->Html->link('My Endorsers', array('controller'=>'Endorsers','action'=>'myEndorser'), array('escape'=>false));
                ?></li>
                <li class="active">Edit Endorser</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          <div class='row'>
            ...
            <div class='col-lg-6 col-md-6 col-sm-12 '>
              <div class="form-group pull-right">
                <?php 
                    $class= 'greenBtn';
                    $titleCommit='Search Recommended Endorsers';
                    $CommitLink= $this->Url->build(["controller" => "Endorsers","action" => "searchRecommendedContacts"]);
                ?>
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Endorsement Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Endorsement Title','class' => 'form-control','type'=>'text','value'=>$fundDetails->title));
                ?>
                <?php 
              ...
              <label>Endorsement Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Endorsement Description','class' => 'form-control','value'=>$fundDetails->description));
                 ?>
                 <?php 
              ...
              <div class="form-group">
              <label>Endorsement Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Endorsement Start Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->start_date));
                ?>
                <?php 
              ...
              <div class="form-group">
              <label>Endorsement End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Endorsement End Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->end_date));
                ?>
                <?php 
              ...
              <div class="form-group">
              <label>Endorsement Keywords</label>
                <?php
                  //$FK= explode(',', $fundDetails->endorsor_keywords_id);
                  //echo $this->Form->input('endorsor_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'endorsor_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Endorsement Keywords Added",'value'=>$FK, 'options'=>$keywordsLists));
                ?> 
                <span class="form-control textAreaKeyword" id="selectedResult31">
                    <ul>
                    <?php 
                      if(isset($_POST['submit'])){
                          if(isset($_POST['endorsor_keywords_id'])){
                            $skey31= $_POST['endorsor_keywords_id'];
                          }else{
                            $skey31=explode(',', $fundDetails->endorsor_keywords_id);
                          }
                ...
                <select name="endorsor_keywords_id[]" multiple="" id="hiddenKey31" style="display: none;">
                    <?php
                      if(!empty($skey31[0])){
                ...
                <?php 
                    echo $this->Form->error('endorsor_keywords_id', null, array('class' => 'error-message'));
                ?>
                <script type="text/javascript">
                  $(function() {
              ...
              <label>Interest Keywords</label>
                <?php
                  //$FM= explode(',', $fundDetails->endorsor_interest_keywords_id);
                  //echo $this->Form->input('endorsor_interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'endorsor_interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added",'value'=>$FM, 'options'=>$intrestKeywordLists));
                ?> 
                <span class="form-control textAreaKeyword" id="selectedResult22">
                    <ul>
                    <?php 
                      if(isset($_POST['submit'])){
                          if(isset($_POST['endorsor_interest_keywords_id'])){
                            $skey22= $_POST['endorsor_interest_keywords_id'];
                          }else{
                            $skey22=explode(',', $fundDetails->endorsor_interest_keywords_id);
                          }
                ...
                <select name="endorsor_interest_keywords_id[]" multiple="" id="hiddenKey22" style="display: none;">
                    <?php
                      if(!empty($skey22[0])){
                ...
                <?php 
                    echo $this->Form->error('endorsor_interest_keywords_id', null, array('class' => 'error-message'));
                ?>
                <script type="text/javascript">
                  $(function() {
