 <div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-8 col-md-8 col-sm-12 ">
      ...
      <?= $this->Form->create($user , ['id'=>'FormField']) ?>
        ...
        <div class="setting_field">
            ...
            <div class="onoffswitch">
              ...
              <input type="checkbox" name="public_profile" class="onoffswitch-checkbox ajaxClass" id="myonoffswitch2" <?php echo $pbpChk; ?>>
        ...
        <span style="color: red; float: right; margin-bottom: 30px;margin-top: -20px;" id="result"></span>
      <?= $this->Form->end() ?>

      <?= $this->Form->create($user , ['id'=>'FormField1']) ?>
        <div class="setting_field">
          <div class="setting_Name"> Register for Beta Tester opportunities</div>
          <div class="onoffswitch" >
      ...
      <?= $this->Form->create($user , ['id'=>'FormField2']) ?>
        <div class="setting_field">
          <div class="setting_Name"> Register for Board Member opportunities</div>
          <div class="onoffswitch" >
      ...
      <?= $this->Form->create($user , ['id'=>'FormField3']) ?>
        <div class="setting_field">
          <div class="setting_Name"> Register for Early Adopter opportunities</div>
          <div class="onoffswitch" >
      ...
      <?= $this->Form->create($user , ['id'=>'FormField4']) ?>
        <div class="setting_field">
          <div class="setting_Name"> Register for Endorser opportunities</div>
          <div class="onoffswitch" >
      ...
      <?= $this->Form->create($user , ['id'=>'FormField5']) ?>
        <div class="setting_field">
          <div class="setting_Name"> Register for Focus Group opportunities</div>
          <div class="onoffswitch" >
      ...
      <?= $this->Form->create($user , ['id'=>'FormField6']) ?>
        <div class="setting_field">
          <div class="setting_Name"> Register for Consulting opportunities</div>
          <div class="onoffswitch" >
  ...
  <div class='row'>
    <div class='col-lg-8 col-md-8 col-sm-12 '>
     <div class="page_heading">
       <h1>Enable/Disable "What's New" Sources </h1> 
      </div>
    </div> 
  </div>
  <!-- header ends --> 
  <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-12 ">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed12']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Audio/Video Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed19']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Beta Test Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed20']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Board Member Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed3']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Campaign Followed Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed31']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Campaign Commited Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed5']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Career Help Tool Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed21']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Comunal Asset Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed15']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Conference Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> My Connections Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed22']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Consulting Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed16']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Demo Day Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed23']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Early Adopter Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed24']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Endorser Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed25']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Focus Group Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed7']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Forum Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed2']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Fund Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed8']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Group Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed28']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Group Buying Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed9']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Hardware Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed13']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Information Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed26']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Job Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed27']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Launch Deal Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed17']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Meetup Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed6']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Organization Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed14']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Productivity Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed4']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Self Improvement Tool Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed11']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Service Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed10']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Software Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed1']) ?>
          ...
          <div class="setting_field">
              <div class="setting_Name"> Startup Updates </div>
              <div class="onoffswitch">
        ...
        <?= $this->Form->create($user , ['id'=>'FormFeed18']) ?>
          <div class="setting_field">
              <div class="setting_Name"> Webinar Updates </div>
              <div class="onoffswitch">
 ...
 $(".ajaxClass").change(function(){
    ...
    $.ajax({ 
            url: "<?php echo $this->Url->build(["Controller" => "Contractors","action" => "ajaxSettings"]);?>",
            data: {type :usertype,status:registerStatus},
            type : 'POST',
            cache: false,
            async : false,
