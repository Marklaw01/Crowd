          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Conference Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Conference Title','class' => 'form-control','type'=>'text','value'=>$fundDetails->title));
                ?>
                <?php 
              ...
              <label>Conference Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Conference Description','class' => 'form-control','value'=>$fundDetails->description));
                 ?>
                 <?php 
              ...
              <label>Conference Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Conference Start Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->start_date));
                ?>
                <?php 
              ...
              <label>Conference End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Conference End Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->end_date));
                ?>
                <?php 
