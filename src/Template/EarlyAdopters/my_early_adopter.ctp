  ...
  <div class="row">
    <div class="col-lg-12 ">
      <ol class="breadcrumb">
        ...
        ?></li>
        <li class="active">My Early Adopters</li>
      </ol>
    </div>
  </div>
  <!-- breadcrumb ends --> 
    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND EARLY ADOPTER', array('controller'=>'EarlyAdopters','action'=>'index'), array('escape'=>false,'class'=>'active '));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'MY EARLY ADOPTERS', array('controller'=>'EarlyAdopters','action'=>'myEarlyAdopter'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div role="tabpanel" class="campaigns-section">
        ...
        <ul id="tabbing" class="nav aboutTab nav-tabs hidden-xs" role="tablist">
          ...
          <?php $mycamp= $this->Url->build(["controller" => "EarlyAdopters","action" => "myEarlyAdopter"]);?>
          <a href="#myFund" aria-controls="My Board Members" role="tab" data-toggle="tab" onclick="location.href='<?php echo $mycamp;?>'">My Early Adopters</a></li>

          <li role="presentation">
          <?php $followi = $this->Url->build(["controller" => "EarlyAdopters","action" => "myArchived"]);?>
          ...
          <li role="presentation">
          <?php $commit= $this->Url->build(["controller" => "EarlyAdopters","action" => "myDeactivated"]);?>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane active whiteBg" id="myFund">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="form-group">
                  <?= $this->Html->link(__('Add Early Adopter'), ['action' => 'add'],['class'=>'customBtn blueBtn  pull-right']) ?>
                </div>
              </div>
                      ...
                      <li>
                       <div class="listingIcon">
                        ...
                        if(!empty($myFundsList['image'])){
                          ...
                          echo $this->Html->link('<img src="'.$this->request->webroot.'img/early_adopter/'.$myFundsList['image'].'" width="50" height="50">',['controller'=>'EarlyAdopters','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);

                        }else{

                          echo $this->Html->link('<i class="icon"><img src="'.$this->request->webroot.'images/campaign.png"></i>',['controller'=>'EarlyAdopters','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);
                        }
                        ?>
                       </div>
                       <div class="listingContent">
                         <div class="headingBar">
                           <h2 class="heading">
                            <?php 
                              echo $this->Html->link($myFundsList['title'],['controller'=>'EarlyAdopters','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);
                            ?>
                           <span>
                           ...
                           <h2 class="likes">
                            <?php echo $likeC = $this->Custom->getEarlyLikeCount($myFundsList->id);?> 
                            
                            <?php 
                            if($this->Custom->isEarlyLikedbyUser($myFundsList->id,$UserId)){
                            ...
                            <?php echo $disLikeC = $this->Custom->getEarlyDislikeCount($myFundsList->id);?> 
                        
                            <?php 
                              if($this->Custom->isEarlyDislikedbyUser($myFundsList->id,$UserId)){
                         ...
                         <p class="date"> Early Adopter Start Date: <?= $myFundsList->start_date; ?>
                         </p>
            ...
            <?php }else { ?>
                <nav>
                  <ul class="pagination pagination-sm">
                    <li>No Early Adopters Available.</li>
                  </ul>
                </nav>  
            <?php } ?>
