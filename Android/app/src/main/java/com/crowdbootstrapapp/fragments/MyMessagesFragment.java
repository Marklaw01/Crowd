...
import com.crowdbootstrapapp.adapter.MessagesAdapter;
...
import com.crowdbootstrapapp.models.NotificationObject;
 ...
 */
public class MyMessagesFragment extends Fragment implements AsyncTaskCompleteListener<String> {
        ...
        if (isVisibleToUser) {
            ...
            try {
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    ...
                    Async a = new Async(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.MYCONNECTIONS_MESSAGES_TAG, Constants.MYCONNECTIONS_MESSAGES_URL + "?loggedin_user_id=" + ((HomeActivity) getActivity()).prefManager.getString(Constants.USER_ID) + "&page_no=" + current_page, Constants.HTTP_GET, "Home Activity");
                    a.execute();
                } else {
    ...
    public void onTaskComplete(String result, String tag) {
        try {
            if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
                ...
                if (tag.equalsIgnoreCase(Constants.MYCONNECTIONS_MESSAGES_TAG)) {
                    ((HomeActivity) getActivity()).dismissProgressDialog();
                    try {
