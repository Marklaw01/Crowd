//
//  AddBoardMemberViewController.m
//  CrowdBootstrap
//
...
#import "AddBoardMemberViewController.h"
...
@interface AddBoardMemberViewController ()

@end

@implementation AddBoardMemberViewController
...
-(void)resetUISettings {
    ...
    self.title = @"Board Membership Requirements";
    [self initializeSectionArray] ;
}

-(void)initializeSectionArray {
    
    NSArray *fieldsArray = @[@"Board Membership Title", @"Board Membership Description", @"Board Membership Start Date", @"Board Membership End Date", @"Target Market", @"Board Membership Keywords", @"Interest Keywords", @"Upload Image"] ;
    NSArray *parametersArray = @[kBoardMemberAPI_BoardMember_Title, kBoardMemberAPI_Description, kBoardMemberAPI_StartDate, kBoardMemberAPI_EndDate, kAddBoardMemberAPI_Target_Market_Keywords, kAddBoardMemberAPI_Keywords, kAddBoardMemberAPI_IndustryKeywords, kBoardMemberAPI_BoardMember_Image] ;
    ...
    if ([type isEqualToString:@"targetmarket"]) {
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kBoardMemberAPI_Target_Market_ID] ;
        ...
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kBoardMemberAPI_KeywordID] ;
                if([selectedValue intValue] == [value intValue]){
        ...
        for (NSDictionary *dict in tagsArray) {
            ...
            for (NSString *obj in array) {
                NSString *selectedValue = [obj valueForKey:kBoardMemberAPI_Industry_ID] ;
                if([selectedValue intValue] == [value intValue]){
...
-(BOOL)textViewShouldBeginEditing:(UITextView *)textView {
    ...
    if([textView.text isEqualToString:@"Board Membership Description"] && textView.textColor == [UIColor lightGrayColor]){
        textView.text = @"" ;
...
-(BOOL)textViewShouldEndEditing:(UITextView *)textView {
    ...
    if([textView.text isEqualToString:@""]){
        textView.text = @"Board Membership Description" ;
...
-(void)createBoardMember {
    if([UtilityClass checkInternetConnection]) {
        ...
        [dictParam setObject:[self convertTagsArrayToStringforArray:selectedTargetMarketKeywordsArray withTagsArray:targetMarketKeywordsArray tagType:@"targetmarket"] forKey:kAddBoardMemberAPI_Target_Market_Keywords] ;
        ...
        [ApiCrowdBootstrap addBoardMemberWithParameters:dictParam success:^(NSDictionary *responseDict) {
            ...
            if([[responseDict valueForKey:@"code"] intValue] == kSuccessCode ) {
                ...
                [UtilityClass showNotificationMessgae:kAddBoardMember_SuccessMessage withResultType:@"0" withDuration:1] ;
