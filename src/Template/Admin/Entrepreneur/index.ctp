<div id="page-content-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12 ">
          <h1 class="page-header"><i class=" fa fa-user-md"></i>Entrepreneurs
          </h1>
          <?php
              ...
              <tbody>
                <?php $count=0; foreach($users as $user){ $count++;?> 
                    <tr>
                      ...
                      <td>
                      <?php
                    echo $this->Html->link('<i class=" fa fa-eye"> </i>', array('controller'=> 'Entrepreneur','action'=>'view',base64_encode($user->id)), array('escape'=>false,'title'=>'View'));
                  ?>
                  <?php
