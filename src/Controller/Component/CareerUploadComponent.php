...
class CareerUploadComponent extends Component
{
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('CareerInterestKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('CareerKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('CareerTargetMarkets');
		...
		* * * * */
		public function isFollowedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('CareerFollowers');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['career_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function isCommitedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('CareerCommitments');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['career_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function getCommitCount($fundId=null)
		{
			...
			$FundDislikes = TableRegistry::get('CareerCommitments');
			$likelists= $FundDislikes->find('all',['conditions'=>['career_id' => $fundId]]);
	    ...
	    ****/
	    ...
	    public function uploadImage($files = null) 
	    {
		    ...
		    if(!empty($files)){
                ...
                $path = WWW_ROOT . "img/career/"; // Upload directory
                $imgCamp='';
                $errors='';
