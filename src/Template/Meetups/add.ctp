          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Add Meet Up</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Meet Up Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Meet Up Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Meet Up Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Meet Up Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Meet Up Availability Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Meet Up Availability Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Meet Up Availability End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Meet Up Availability End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Add Forum</label>
                <?php
                  echo $this->Form->input('forum_id', array('options'=>$forums, 'label'=>false,'class' => 'form-control  scrollable custom-select','empty'=>'Select your forum')); 
                ?>
                <?php 
              ...
              <label>Meet Up Access </label>
                <?php
                  ...
                  echo $this->Form->input('access_level', array('options'=>$access_level, 'label'=>false,'class' => 'form-control  scrollable custom-select','empty'=>'Select Access Level')); 
                ?>
                <?php 
             ...
             <div class="form-group">
              <label>Meet Up Notification </label>
                <?php
                  ...
                  echo $this->Form->input('send_notifications', array('options'=>$notification, 'label'=>false,'class' => 'form-control  scrollable custom-select','empty'=>'Select Notification')); 
                ?>
                <?php 
              ...
              <label>Target Market</label>
                <?php
                  //echo $this->Form->input('target_market', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'target_market','multiple'=>true,'type'=>'select','title'=>"No Target Market Added", 'options'=>$targetMarketLists));
                ?> 
              ...
              <label>Meet Up Keywords</label>
                <?php
                  //echo $this->Form->input('keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'keywords_id','multiple'=>true,'type'=>'select','title'=>"No Meet Up Keywords Added", 'options'=>$keywordsLists));
                ?> 
              ...
              <label>Interest Keywords</label>
                <?php
                  //echo $this->Form->input('interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added", 'options'=>$intrestKeywordLists));
                ?> 
