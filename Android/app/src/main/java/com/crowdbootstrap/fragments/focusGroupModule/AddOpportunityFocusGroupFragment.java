 ...
 */
public class AddOpportunityFocusGroupFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddOpportunityFocusGroupFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyOpportunityFocusGroupFragments();
                    case 1:
                        return new ArchivedFocusGroupFragment();
                    case 2:
                        return new DeactivatedFocusGroupFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
