...
<div class="container-fluid">
          ...
          <div class='row'>
            <div class='col-lg-12 col-md-12 col-sm-12 '>
              <h1 class="page-header"><i class=" fa fa-comments-o"></i>View Forum</h1> 
            </div>
         ...
         <div class="forum_image">
          <?php if(!empty($forumDetails->image)){?>
                <img src="<?php echo $this->request->webroot; ?>img/forums/<?php echo $forumDetails->image;?>" alt="" height="400" width="440">
          <?php }else {?>
