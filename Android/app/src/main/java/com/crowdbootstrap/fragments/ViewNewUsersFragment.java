...
import com.crowdbootstrap.adapter.AnonymousUserAdapter;
...
import com.crowdbootstrap.models.AnonymousUserObject;
...
//            });
    ...
    public void alertDialog(String imageUrl) {
        ...
        TouchImageView imageView = (TouchImageView) dialog.findViewById(R.id.roadmapImage);
        Button okText = (Button) dialog.findViewById(R.id.btn_ok);
