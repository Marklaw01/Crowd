 ...
 */
public class AddOpportunityCommunalAssetsFragment extends Fragment {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddOpportunityCommunalAssetsFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyOpportunityCommunalAssetsFragments();
                    case 1:
                        return new ArchivedCommunalAssetsFragment();
                    case 2:
                        return new DeactivatedCommunalAssetsFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
