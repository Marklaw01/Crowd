 ...
 */
public class UpdateRequestBetaTesterFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    private Button btnCreate, searchBetaTester;
    ...
    private String beta_id = "0";
    private Bundle bundle;
    public static boolean viewFiles;

    public UpdateRequestBetaTesterFragment() {
        super();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        beta_id = bundle.getString(Constants.FUND_ID);
        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
            ((HomeActivity) getActivity()).showProgressDialog();
            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.BETA_TEST_KEYWORDS_LIST_TAG, Constants.BETA_TEST_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
            a.execute();
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        searchBetaTester = (Button) rootView.findViewById(R.id.searchBetaTesters);
        ...
        searchBetaTester.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Bundle bundleSearch = new Bundle();
                bundleSearch.putString(Constants.FUND_ID, beta_id);
                BetaTesterSearchFragment betaTestersSearchFragment = new BetaTesterSearchFragment();
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    update(map, Constants.UPDATE_BETA_TEST_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
    ...
    public void onTaskComplete(String result, String tag) {
        if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
            ...
            } else if (tag.equals(Constants.BETA_TEST_DETAILS_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
