 ...
 */
public class BetaTesterAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public BetaTesterAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
