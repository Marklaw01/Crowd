...
public class BoardMembersFragment  extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity)getActivity()).setActionBarTitle(getString(R.string.board_members));
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new SearchOpportunityBoardMembersFragment();
                    case 1:
                        return new AddOpportunityBoardMembersFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
