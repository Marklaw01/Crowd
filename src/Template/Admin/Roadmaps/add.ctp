<div id="page-content-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 ">
          <h1 class="page-header"><i class="fa fa-users"></i>Add Milestone 
          </h1>
          <?php
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-8 col-sm-12 ">
                        ...
                        <label>Order</label>
                          ...
                          <?php
                            echo $this->Form->input('order_id', ARRAY('label' => false, 'div' => false, 'class' => ' selectpicker form-control show-tick', 'id' => 'order_id','type'=>'select','empty'=>'Top', 'options'=>$roadmaplist));
                          ?>
                        </div>
