                 ...
                 <!-- 1Tab-->
                  ...
                  <div role="tabpanel" class="tab-pane active whiteBg" id="docs">
                      ...
                      <?php if($userApprovStatus == 1){?>
                          <?php
                              echo $this->Html->link('<i class="fa fa-copy"></i>Add ', array('controller'=>'Startups','action'=>'addStartupDocsContractor',$startupId), array('escape'=>false, 'class'=>'customBtn blueBtn'));
                          ?>
                      <?php } ?> 
                      </div>
                     <div class="table-responsive">
                         <table class="table table-striped startup-list">
                            ...
                            <?php $accessUser=$startupDocList->access;
                             $startUpUser= $startupDocList->startup->user_id;
                                    $accessUserArray= explode(",",$accessUser);
                                    if(in_array($UserId, $accessUserArray) or $startUpUser ==$UserId or $startupDocList->user_id==$UserId){
                            ?>
                              <tr>
                                    <td>
                                      <?php 
                                    ...
                                    <?php if($userApprovStatus == 1){?>
                                          <?php 
                                          if($startupDocList->user_id==$UserId){?>
                                            <?php
