  ...
  <div class="row">
    <div class="col-lg-12 ">
      <ol class="breadcrumb">
        ...
        ?></li>
        <li class="active">My Meet Ups</li>
      </ol>
    </div>
  </div>
  <!-- breadcrumb ends --> 
    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND MEET UP', array('controller'=>'Meetups','action'=>'index'), array('escape'=>false,'class'=>'active '));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'MY MEET UPS', array('controller'=>'Meetups','action'=>'myMeetup'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div role="tabpanel" class="campaigns-section">
        ...
        <ul id="tabbing" class="nav aboutTab nav-tabs hidden-xs" role="tablist">
          ...
          <?php $mycamp= $this->Url->build(["controller" => "Meetups","action" => "myMeetup"]);?>
          <a href="#myFund" aria-controls="My Meet Ups" role="tab" data-toggle="tab" onclick="location.href='<?php echo $mycamp;?>'">My Meet Ups</a></li>

          <li role="presentation">
          <?php $followi = $this->Url->build(["controller" => "Meetups","action" => "myArchived"]);?>
          ...
          <li role="presentation">
          <?php $commit= $this->Url->build(["controller" => "Meetups","action" => "myDeactivated"]);?>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane active whiteBg" id="myFund">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 ">
              <div class="form-group">
                <?= $this->Html->link(__('Add Meet Up'), ['action' => 'add'],['class'=>'customBtn blueBtn  pull-right']) ?>
              </div>
            </div>
                      ...
                      <li>
                       ...
                       <div class="listingContent">
                         <div class="headingBar">
                           ...
                           <h2 class="likes">
                            <?php echo $likeC = $this->Custom->getMeetupLikeCount($myFundsList->id);?> 
                            
                            <?php 
                            if($this->Custom->isMeetupLikedbyUser($myFundsList->id,$UserId)){
                            ...
                            <?php echo $disLikeC = $this->Custom->getMeetupDislikeCount($myFundsList->id);?> 
                        
                            <?php 
                              if($this->Custom->isMeetupDislikedbyUser($myFundsList->id,$UserId)){
