...
class EarlyAdoptersTable extends Table
{
    public function initialize(array $config)
    { 
        parent::initialize($config);
        $this->addBehavior('Timestamp');
        $this->table('early_adopters');
    ...
    public function validationDefault(Validator $validator)
    {
            ...
            $validator
                ->requirePresence('early_interest_keywords_id', 'create')
                ->notEmpty('early_interest_keywords_id','Please select industries.');


            $validator
                ->requirePresence('early_keywords_id', 'create')
