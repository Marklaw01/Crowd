package com.crowdbootstrap.adapter.boardMembersAdapters;
...
import com.crowdbootstrap.fragments.boardMembersModule.BoardMembersLikeDislikeFragment;
 ...
 */
public class DeactivatedBoardMembersAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedBoardMembersAdapter(Context context, ArrayList<FundsObject> list) {
