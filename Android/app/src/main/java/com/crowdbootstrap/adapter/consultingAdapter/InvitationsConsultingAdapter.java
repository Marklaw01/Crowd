package com.crowdbootstrap.adapter.consultingAdapter;
...
import com.crowdbootstrap.fragments.consultingModule.ConsultingLikeDislikeFragment;
...
/**
 * Created by Sunakshi.Gautam on 5/12/2017.
 */

public class InvitationsConsultingAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public InvitationsConsultingAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_sentByName = (TextView) convertView.findViewById(R.id.tv_sentBy);
        ...
        try {
            ...
            holder.tv_sentByName.setVisibility(View.VISIBLE);
            holder.tv_deactivate.setVisibility(View.GONE);
            holder.tv_archive.setText("Accept");
            ...
            holder.tv_sentByName.setText("Invitation Received From: "+list.get(position).getSent_by_name());

            if (list.get(position).getAward_status().compareTo("0") == 0) {
                holder.tv_status.setText("Status: Not Awarded");
            }
            else if(list.get(position).getAward_status().compareTo("1") == 0){
                holder.tv_status.setText("Status: Awarded");
            }
            else if(list.get(position).getAward_status().compareTo("2") == 0){
            ...
            holder.tv_delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to reject the invitation?", Constants.REJECT_INVITE_CONSULTING);
                }
            });
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to accept the invitation?", Constants.ACCEPT_INVITE_CONSULTING);
                }
            });
                    ...
                    public void onClick(DialogInterface dialog, int arg1) {
                        ...
                        if (networkConnectivity.isInternetConnectionAvaliable()) {
                            ...
                            try {
                                ...
                                obj.put("sent_by", list.get(position).getSent_by());
    ...
    static class ViewHolder {
        TextView fundTitle, fundDescription, tv_postedDate, tv_Likes, tv_dislikes, tv_archive, tv_delete, tv_deactivate, tv_status;
        TextView tv_sentByName;
