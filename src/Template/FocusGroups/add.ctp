          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Add Focus Group</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Focus Group Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Focus Group Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Focus Group Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Focus Group Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Focus Group Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Focus Group Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Focus Group End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Focus Group End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Focus Group Keywords</label>
                <?php
                  //echo $this->Form->input('focus_group_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'focus_group_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Focus Group Keywords Added", 'options'=>$keywordsLists));
                ?> 
              ...
              <label>Interest Keywords</label>
                <?php
                  //echo $this->Form->input('focus_group_interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'focus_group_interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added", 'options'=>$intrestKeywordLists));
                ?> 
