            ...
            <div class="col-lg-8 col-md-8 col-sm-12 ">
               <div class="form-group">
                    ...
                    <label>Startup Roadmap</label>
                      <?php
                          echo $this->Form->input('roadmap_id', ARRAY('label' => false, 'div' => false,'error' => false, 'class' => 'selectpicker form-control', 'title'=>'Select Roadmap','data-size'=>'10', 'type'=>'select','options' => $roadmaps));
                      ?>
                      <?php 
               ...
               <?php  foreach($startupMemberLists as $startupsMemberList){ $c++;?>
                      <?php if($startupsMemberList->user_id != $UserId) {?> 
                         <div class="form-group">
                         <?php //if(!empty($startupsMemberList->user)) { ?>
