package com.crowdbootstrap.adapter.servicesAdapter;
...
import com.crowdbootstrap.fragments.servicesmodule.ServicesLikeDislikeFragment;
 ...
 */
public class DeactivatedServicesAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedServicesAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        try {
           ...
           // holder.dislikeBtn.setOnClickListener(this);
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this resource?", Constants.SERVICES_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
