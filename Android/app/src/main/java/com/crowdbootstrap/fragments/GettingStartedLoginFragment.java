...
import com.crowdbootstrap.activities.GettingStartedVideoActivity;

/**
 * Created by Sunakshi.Gautam on 12/27/2017.
 */

public class GettingStartedLoginFragment extends Fragment implements View.OnClickListener {
    ...
    public GettingStartedLoginFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        networkingText.setVisibility(View.GONE);
...
//                finish();
                ...
                LoginInfoFragment.selectPage(0);
                break;
