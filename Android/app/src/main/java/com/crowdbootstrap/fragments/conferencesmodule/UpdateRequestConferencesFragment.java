 ...
 */
public class UpdateRequestConferencesFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public UpdateRequestConferencesFragment() {
        super();
    }
    ...
    public void onResume() {
        ...
        if (viewFiles == true) {
            ...
            if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                ...
                AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.CONFERENCE_KEYWORDS_LIST_TAG, Constants.CONFERENCE_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                a.execute();
            } else {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        searchFocusGroups.setText("Search Recommended Conference");
        searchFocusGroups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ConferencesSearchFragment betaTestersSearchFragment = new ConferencesSearchFragment();
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    update(map, Constants.UPDATE_CONFERENCE_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
    ...
    public void onTaskComplete(String result, String tag) {
        if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
            ...
            if (tag.equals(Constants.CONFERENCE_KEYWORDS_LIST_TAG)) {
                ...
                try {
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.CONFERENCE_INTEREST_KEYWORDS_LIST_TAG, Constants.CONFERENCE_INTEREST_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.CONFERENCE_INTEREST_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.CONFERENCE_TARGET_MARKET_KEYWORDS_LIST_TAG, Constants.CONFERENCE_TARGET_MARKET_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.CONFERENCE_TARGET_MARKET_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
            ...
            } else if (tag.equals(Constants.CONFERENCE_DETAILS_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
