          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li> <?php
                    echo $this->Html->link('Early Adopters', array('controller'=>'EarlyAdopters','action'=>'myEarlyAdopter'), array('escape'=>false));
                ?></li>
                <li class="active">Search Recommended Early Adopters</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          <div class='row'>
            <div class='col-lg-12 col-md-12 col-sm-12 '>
             <div class="page_heading">
               <h1>Search Recommended Early Adopters</h1> 
              </div>
            </div>
