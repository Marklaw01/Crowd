 ...
 */
public class AddResourceProductivityFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceProductivityFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesProductivityFragments();
                    case 1:
                        return new ArchivedProductivityFragment();
                    case 2:
                        return new DeactivatedProductivityFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
