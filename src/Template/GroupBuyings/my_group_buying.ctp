    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND PURCHASE ORDER', array('controller'=>'GroupBuyings','action'=>'index'), array('escape'=>false,'class'=>'active '));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'ADD PURCHASE ORDER', array('controller'=>'GroupBuyings','action'=>'myGroupBuying'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
      </div>
    </div>
  </div>
      ...
      <div role="tabpanel" class="campaigns-section">
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane active whiteBg" id="myFund">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="form-group">
                  <?= $this->Html->link(__('Add Purchase Order'), ['action' => 'add'],['class'=>'customBtn blueBtn  pull-right']) ?>
                </div>
              </div>
                      ...
                      <li>
                       <div class="listingIcon">
                        ...
                        if(!empty($myFundsList['image'])){
                          ...
                          echo $this->Html->link('<img src="'.$this->request->webroot.'img/groupbuying/'.$myFundsList['image'].'" width="50" height="50">',['controller'=>'GroupBuyings','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);

                        }else{

                          echo $this->Html->link('<i class="icon"><img src="'.$this->request->webroot.'images/campaign.png"></i>',['controller'=>'GroupBuyings','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);
                        }
                        ?>
                       </div>
                       <div class="listingContent">
                         <div class="headingBar">
                           <h2 class="heading">
                            <?php 
                              echo $this->Html->link($myFundsList['title'],['controller'=>'GroupBuyings','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);
                            ?>
                           <span>
                           ...
                           <h2 class="likes">
                            <?php echo $likeC = $this->Custom->getGroupBuyingLikeCount($myFundsList->id);?> 
                            
                            <?php 
                            if($this->Custom->isGroupBuyingLikedbyUser($myFundsList->id,$UserId)){
                            ...
                            <?php echo $disLikeC = $this->Custom->getGroupBuyingDislikeCount($myFundsList->id);?> 
                        
                            <?php 
                              if($this->Custom->isGroupBuyingDislikedbyUser($myFundsList->id,$UserId)){
            ...
            <?php }else { ?>
                <nav>
                  <ul class="pagination pagination-sm">
                    <li>No Purchase Order Available.</li>
                  </ul>
                </nav>  
            <?php } ?>
