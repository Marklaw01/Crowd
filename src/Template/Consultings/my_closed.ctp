        ...
        <div class="tab-content">
         <!-- 1Tab-->
          ...
          <div role="tabpanel" class="tab-pane whiteBg" id="myArchived">   
           ...
           <!--  4Tab -->
          <div role="tabpanel" class="tab-pane active whiteBg" id="myClosed">
                    ...
                    <li>
                     ...
                     <div class="listingContent">
                       ...
                       <p class="date">Start Date: <?= $myFundsList->project_start_date; ?>
                        <p class="date">Winning Bidder: 
                          <?php  
                            $ContId = $this->Custom->isGetConustingWinningBidder($myFundsList->id);
                            if(!empty($ContId)){
                                echo $ContNam = $this->Custom->contractorName($ContId);
                            }else{
                                echo "Not Awarded";
                            }    
                          ?>
                       ...
                       <div class="links alignRight">
                        ...
                        <?php 
                           ...
                           echo $this->Form->postLink('Open',['action' => 'open', base64_encode($myFundsList->id)],['id'=>'acPost'.$c,'class'=>'smallCurveBtnMsg greenBtn customBtnMsg']);
                        ?>
                      ...
                      <script type="text/javascript">
                       $(document).ready(function () {
                           ...
                           $('#acPost<?php echo $c;?>').html('<i class="fa fa-toggle-on "></i>Open');
