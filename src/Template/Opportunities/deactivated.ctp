                          ...
                          <li>
                           ...
                           <div class="listingContent">
                             ...
                             <div class="links alignRight">
                              ...
                              ?>
                              <?php 
                                 echo $this->Form->postLink('Archive',['action' => 'archiveJob', base64_encode($myJob->id)],['id'=>'archPost'.$c,'class'=>'smallCurveBtnJobs greenBtn customBtn ','title'=>'Archive']);
                              ?>
                              <?php 
                                 echo $this->Form->postLink('Activate',['action' => 'activateJob', base64_encode($myJob->id)],['id'=>'deactPost'.$c,'class'=>'smallCurveBtnJobs orangeBtn customBtn ','title'=>'Activate']);
                              ?>
                              <?php 
                            ...
                            <script type="text/javascript">
                             $(document).ready(function () {
                                 ...
                                 $('#deactPost<?php echo $c;?>').html('<i class="fa fa-check"></i>');
                              });   
                            </script>
                          </li>  
                    <?php endforeach; ?>
