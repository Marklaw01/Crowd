    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND INFROMATION', array('controller'=>'Informations','action'=>'index'), array('escape'=>false,'class'=>'active '));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'MY INFROMATION', array('controller'=>'Informations','action'=>'myInformation'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div role="tabpanel" class="campaigns-section">
        ...
        <ul id="tabbing" class="nav aboutTab nav-tabs hidden-xs" role="tablist">
          ...
          <?php $mycamp= $this->Url->build(["controller" => "Informations","action" => "myInformation"]);?>
          ...
          <?php $followi = $this->Url->build(["controller" => "Informations","action" => "myArchived"]);?>
          ...
          <li role="presentation">
          <?php $commit= $this->Url->build(["controller" => "Informations","action" => "myDeactivated"]);?>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane active whiteBg" id="myFund">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="form-group">
                  <?= $this->Html->link(__('Add Information'), ['action' => 'add'],['class'=>'customBtn blueBtn  pull-right']) ?>
                </div>
              </div>
                      ...
                      <li>
                       <div class="listingIcon">
                        ...
                        if(!empty($myFundsList['image'])){
                          ...
                          echo $this->Html->link('<img src="'.$this->request->webroot.'img/information/'.$myFundsList['image'].'" width="50" height="50">',['controller'=>'Informations','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);

                        }else{

                          echo $this->Html->link('<i class="icon"><img src="'.$this->request->webroot.'images/campaign.png"></i>',['controller'=>'Informations','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);
                        }
                        ?>
                       </div>
                       <div class="listingContent">
                         <div class="headingBar">
                           <h2 class="heading">
                            <?php 
                              echo $this->Html->link($myFundsList['title'],['controller'=>'Informations','action'=>'view',$fundId],['escape'=>false,'title'=>'Click Here View']);
                            ?>
                           <span>
                           ...
                           <h2 class="likes">
                            <?php echo $likeC = $this->Custom->getInformationLikeCount($myFundsList->id);?> 
                            
                            <?php 
                            if($this->Custom->isInformationLikedbyUser($myFundsList->id,$UserId)){
                            ...
                            <?php echo $disLikeC = $this->Custom->getInformationDislikeCount($myFundsList->id);?> 
                        
                            <?php 
                              if($this->Custom->isInformationDislikedbyUser($myFundsList->id,$UserId)){
