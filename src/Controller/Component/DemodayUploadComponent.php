...
class DemodayUploadComponent extends Component
{
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('DemodayInterestKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('DemodayKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('DemodayTargetMarkets');
		...
		* * * * */
		public function isFollowedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('DemodayFollowers');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['demoday_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function isCommitedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('DemodayCommitments');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['demoday_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function getCommitCount($fundId=null)
		{
			...
			$FundDislikes = TableRegistry::get('DemodayCommitments');
			$likelists= $FundDislikes->find('all',['conditions'=>['demoday_id' => $fundId]]);
	    ...
	    ****/
	    ...
	    public function uploadImage($files = null) 
	    {
		    ...
		    if(!empty($files)){
                ...
                $path = WWW_ROOT . "img/demoday/"; // Upload directory
                $imgCamp='';
                $errors='';
