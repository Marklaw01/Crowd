 ...
 */
public class AddResourceHardwareFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceHardwareFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesHardwareFragments();
                    case 1:
                        return new ArchivedHardwareFragment();
                    case 2:
                        return new DeactivatedHardwareFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
