 ...
 */
public class RequestEarlyAdoptorsFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public RequestEarlyAdoptorsFragment() {
        super();
    }
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    create(map, Constants.CREATE_EARLY_ADOPTORS_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
