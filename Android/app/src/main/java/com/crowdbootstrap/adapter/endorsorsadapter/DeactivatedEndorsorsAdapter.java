 ...
 */
public class DeactivatedEndorsorsAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedEndorsorsAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        try {
           ...
           // holder.dislikeBtn.setOnClickListener(this);
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this Opportunity?", Constants.ENDORSOR_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
