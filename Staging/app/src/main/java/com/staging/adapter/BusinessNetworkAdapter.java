...
public class BusinessNetworkAdapter extends BaseAdapter implements Filterable {
    ...
    public BusinessNetworkAdapter(Context context, ArrayList<ContractorsObject> list, String type, String consultingID) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
     ...
     ViewHolder holder;
        ...
        try {
            ...
            if(!list.get(position).getBusinessConnectionTypeId().isEmpty()){
                holder.tv_rate.setText("Connected");
            }else{
                holder.tv_rate.setTextColor(Color.parseColor("#032741"));
                holder.tv_rate.setText("Not Connected");
            }
