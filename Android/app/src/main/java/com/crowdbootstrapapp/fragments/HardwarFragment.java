 ...
 */
public class HardwarFragment extends Fragment {

    private TextView dummyText;

    public HardwarFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dummyText.setText("Coming soon - A list of communal hardware modules that are available for use by Crowd Bootstrap startups.");
        return rootView;
    }
}