          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Connect Social Media</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
                      ...
                      <div class="col-lg-8 col-md-8 col-sm-12 ">
                        <div class="">
                          <div class="circle-img" >
                                  ...
                                  ?>
                                  <?php if(!empty($linkedin['picture-url'])) { ?>
                                        <?php echo $this->Html->image($linkedin['picture-url'],array('id'=>'blah','width'=>'','height'=>'')); 

                                          echo $this->Form->hidden('linkedin_image',ARRAY('value' => $linkedin['picture-url']));
                                        ?>
                                  <?php }else { ?>
                                        <img id="blah" src="" alt="">
                                  <?php } ?>
                        ...
                        <div class="form-group">
                          <b> <?php 
                            echo $linkedin['first-name']." ".$linkedin['last-name'];
                            echo $this->Form->hidden('linkedin_username',ARRAY('value' => $linkedin['first-name']." ".$linkedin['last-name']));
                            ?></b>
                        </div>
                        ...
                        <label>User's Bio</label>
                           <?php
                                echo $this->Form->input('user_bio', ARRAY('label' => false, 'div' => false,'error' => false, 'class' => 'form-control', 'maxlength' => '50','placeholder'=>'Bio','value'=>$linkedin['public-profile-url']));
                             ?>
                           <?php 
