...
public class EndorsersFragment  extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity)getActivity()).setActionBarTitle(getString(R.string.endorsers));
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new SearchOpportunityEndorsersFragment();
                    case 1:
                        return new AddOpportunityEndorsersFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    return getString(R.string.myEndorsors);
            }
            return null;
        }
    }
