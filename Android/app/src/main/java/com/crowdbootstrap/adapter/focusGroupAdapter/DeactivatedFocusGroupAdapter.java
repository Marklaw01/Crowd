package com.crowdbootstrap.adapter.focusGroupAdapter;
...
import com.crowdbootstrap.fragments.focusGroupModule.FocusGroupLikeDislikeFragment;
 ...
 */
public class DeactivatedFocusGroupAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedFocusGroupAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        try {
           ...
           // holder.dislikeBtn.setOnClickListener(this);
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this opportunity?", Constants.FOCUS_GROUP_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
