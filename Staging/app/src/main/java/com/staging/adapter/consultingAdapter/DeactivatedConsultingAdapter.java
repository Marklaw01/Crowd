 ...
 */
public class DeactivatedConsultingAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedConsultingAdapter(Context context, ArrayList<FundsObject> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_archive.setText("Open");
        ...
        try {
            ...
            if(!(list.get(position).getAward_status().compareTo("") == 0)) {
                holder.tv_status.setText("Winning Bidder : " + list.get(position).getAward_status());
            }
            else{
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to open this assignment?", Constants.CONSULTING_OPEN_URL);
                }
            });
        } catch (Exception e) {
