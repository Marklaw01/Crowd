  ...
  <div class="row">
    <div class="col-lg-12 ">
      <ol class="breadcrumb">
        ...
        ?></li>
        <li class="active">Find Board Member</li>
      </ol>
    </div>
  </div>
  <!-- header ends --> 
    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND BOARD MEMBER', array('controller'=>'BoardMembers','action'=>'index'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'MY BOARD MEMBERS', array('controller'=>'BoardMembers','action'=>'myBoardMember'), array('escape'=>false,'class'=>'active'));
          ?>
      </div>
    </div>
  </div>
                ...
                <?php $ss=0; foreach($myFundsLists AS $myFundsList){ $ss++; ?>
                    <tr>
                      ...
                      <td>
                        ...
                        echo $this->Html->link('View',['controller'=>'BoardMembers','action'=>'view',$fundId],['class'=>'fa fa-angle-double-right']);
                        ?>
                      </td>
