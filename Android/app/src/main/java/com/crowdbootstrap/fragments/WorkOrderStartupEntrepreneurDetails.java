...
import com.crowdbootstrap.adapter.WorkOrderEntrepreneurTableAdapter;
import com.crowdbootstrap.listeners.AsyncTaskCompleteListener;
import com.crowdbootstrap.models.RoadmapDeliverables;
import com.crowdbootstrap.models.WorkOrderItem;
...
/**
 * Created by Sunakshi.Gautam on 11/4/2016.
 */
public class WorkOrderStartupEntrepreneurDetails extends Fragment implements AsyncTaskCompleteListener<String> {
...
//    private EditText edt_Workunit;
    ...
    private String bundled_week_no;
    private String bundled_contractor_id;
    private String bundled_startup_id;
    private String bundled_startup_teamid;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            bundled_week_no = getArguments().getString("week_no");
            bundled_contractor_id = getArguments().getString("contractor_id");
            bundled_startup_id = getArguments().getString("startup_id");
            bundled_startup_teamid = getArguments().getString("startup_teamid");
            ...
            if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                ...
                try {
                    ...
                    jsonObject.put("entrepreneur_id", ((HomeActivity) getActivity()).prefManager.getString(Constants.USER_ID));
                    jsonObject.put("contractor_id", bundled_contractor_id);
                    jsonObject.put("week_no", bundled_week_no);
                    jsonObject.put("startup_team_id", bundled_startup_teamid);
                    jsonObject.put("startup_id", bundled_startup_id);


                } catch (JSONException e) {
                    e.printStackTrace();
                }
                Async a = new Async(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.ENTREPRENEUR_STARTUP_WORKORDER_TAG, Constants.ENTREPRENEUR_STARTUP_WORKORDER_URL, Constants.HTTP_POST, jsonObject, "Home Activity");
                a.execute();
            } else {
...
//                edt_Workunit_date.setText(DateTimeFormatClass.convertDateObjectToMMDDYYYFormat(myCalendar.getTime()));
        ...
        submitRatingComments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str_given_by = entrepreneur_id;
                String str_given_to = contractor_id;
                String str_is_entrepreneur = "1";
                String str_startup_id = startUP_ID;
                String str_startup_team_id = startup_teamId;
                String str_status = "1";
                String str_week_no = week_no;
                String str_work_comment = entrepreneursComment.getText().toString();
    ...
    public class MyAdapter extends WorkOrderEntrepreneurTableAdapter {
...
//                    edt_Workunit_date.setText("Date");
            ...
            } else if (tag.equalsIgnoreCase(Constants.ENTREPRENEUR_STARTUP_WORKORDER_TAG)) {
