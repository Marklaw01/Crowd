         ...
         <div class='row'>
                      ...
                      <li>
                       ...
                       <div class="listingContent">
                        ...
                        <div class="links alignRight">
                            <?php 
                              echo $this->Html->link('<i class="fa fa-eye"></i>View', array('controller'=>'contractors', 'action' => 'viewProfile', base64_encode($user->id),$startupId), array('escape'=>false,'class'=>'smallCurveBtn blueBtn customBtn'));
                            ?>
                         </div>
                      </div>
                      </li> 
          ...
          <nav class="pagingNav">
                      <ul class="pagination pagination-sm">
                        ...
                        <?php }else {
                          echo "<li>No Contractors Available.";
                          } ?>    
                      </ul>
        </nav>
        </div>
