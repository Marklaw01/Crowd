  ...
  <div class="row">
    <div class="col-lg-12 ">
      <ol class="breadcrumb">
        ...
        ?></li>
        <li class="active">Archived Board Members</li>
      </ol>
    </div>
  </div>
  <!-- breadcrumb ends --> 
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div role="tabpanel" class="campaigns-section">
        ...
        <ul id="tabbing" class="nav aboutTab nav-tabs hidden-xs" role="tablist">
          ...
          <a href="#myFund" aria-controls="My Beta Tests" role="tab" data-toggle="tab" onclick="location.href='<?php echo $mycamp;?>'">My Board Members</a></li>
