package com.crowdbootstrap.adapter.webinarAdapter;
...
import com.crowdbootstrap.fragments.webinarsmodule.WebinarsLikeDislikeFragment;
 ...
 */
public class WebinarAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public WebinarAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.tv_delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to delete this event?", Constants.WEBINAR_DELETE_URL);
                }
            });
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to archive this event?", Constants.WEBINAR_ARCHIEVE_URL);
                }
            });
            ...
            holder.tv_deactivate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to deactivate this event?", Constants.WEBINAR_DEACTIVATE_URL);
                }
            });
                    ...
                    public void onClick(DialogInterface dialog, int arg1) {
                        ...
                        if (networkConnectivity.isInternetConnectionAvaliable()) {
                            ...
                            try {
                                ...
                                obj.put("webinar_id", list.get(position).getId());
        ...
        switch (v.getId()) {
            case R.id.like:
                ...
                if (list.get(tagLikePosition).getIs_liked_by_user() == 1) {
                    ...
                    try {
                        JSONObject likeObj = new JSONObject();
                        likeObj.put("like_by", PrefManager.getInstance(context).getString(Constants.USER_ID));
                        likeObj.put("webinar_id", list.get(tagLikePosition).getId());
                        fundLikeDislike(tagLikePosition, Constants.WEBINAR_LIKE_URL, Constants.HTTP_POST_REQUEST, likeObj);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
            ...
            case R.id.dislike:
                ...
                if (list.get(tagDislikeIdPosition).getIs_disliked_by_user() == 1) {
                    ...
                    try {
                        JSONObject dislikeObj = new JSONObject();
                        dislikeObj.put("dislike_by", PrefManager.getInstance(context).getString(Constants.USER_ID));
                        dislikeObj.put("webinar_id", list.get(tagDislikeIdPosition).getId());
                        fundLikeDislike(tagDislikeIdPosition, Constants.WEBINAR_DISLIKE_URL, Constants.HTTP_POST_REQUEST, dislikeObj);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
            ...
            case R.id.tv_Like:
                ...
                if (list.get(tagLikeId).getFund_likes() != 0) {
                    ...
                    Fragment likeFragment = new WebinarsLikeDislikeFragment();
            ...
            case R.id.tv_dislike:
                ...
                if (list.get(tagDislikeId).getFund_dislike() != 0) {
                    ...
                    Fragment dislikeFragment = new WebinarsLikeDislikeFragment();
