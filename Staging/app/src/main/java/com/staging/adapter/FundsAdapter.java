        ...
        switch (v.getId()) {
            /*case R.id.like:
                ...
                try {
                    ...
                    fundLikeDislike(tagLikePosition, Constants.FUND_LIKE_URL, Constants.HTTP_POST_REQUEST, likeObj, v);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                break;
            case R.id.dislike:
                ...
                try {
                    ...
                    fundLikeDislike(tagDislikeIdPosition, Constants.FUND_DISLIKE_URL, Constants.HTTP_POST_REQUEST, dislikeObj, v);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                break;*/
