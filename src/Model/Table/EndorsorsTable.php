...
class EndorsorsTable extends Table
{
    public function initialize(array $config)
    { 
        parent::initialize($config);
        $this->addBehavior('Timestamp');
        $this->table('endorsors');
    ...
    public function validationDefault(Validator $validator)
    {
            ...
            $validator
                ->requirePresence('endorsor_interest_keywords_id', 'create')
                ->notEmpty('endorsor_interest_keywords_id','Please select industries.');


            $validator
                ->requirePresence('endorsor_keywords_id', 'create')
                ->notEmpty('endorsor_keywords_id','Please select keywords.');
