          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li> <?php
                    echo $this->Html->link('Focus Groups', array('controller'=>'FocusGroups','action'=>'myFocusGroup'), array('escape'=>false));
                ?></li>
                <li class="active">Search Recommended Focus Groups</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          <div class='row'>
            <div class='col-lg-12 col-md-12 col-sm-12 '>
             <div class="page_heading">
               <h1>Search Recommended Focus Groups</h1> 
              </div>
            </div>
