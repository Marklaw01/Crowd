 ...
 */
public class BoardMembersAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public BoardMembersAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
