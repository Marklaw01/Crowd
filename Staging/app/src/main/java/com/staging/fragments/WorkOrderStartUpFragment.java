...
import com.staging.adapter.WorkOrderContractorTableAdapter;
...
public class WorkOrderStartUpFragment extends Fragment implements AsyncTaskCompleteListener<String> {
    ...
    private TextView entrepreneurCommentLabel, contractorCommentLabel;
...
//    private EditText edt_Workunit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        entrepreneurCommentLabel = (TextView) rootView.findViewById(R.id.entLabel);
        contractorsComment = (EditText) rootView.findViewById(R.id.contractorscomment);
        contractorCommentLabel = (TextView) rootView.findViewById(R.id.contLabel);
        ...
        } else if (CurrentStartUpDetailFragment.from.compareTo("feeds_home") == 0) {
            entrepreneurRating.setVisibility(View.GONE);
            btnUpdateWorkOrder.setVisibility(View.GONE);
            btnDownloadWorkOrder.setVisibility(View.GONE);
            submitRatingComments.setVisibility(View.GONE);
            entrepreneursComment.setVisibility(View.GONE);
            contractorsComment.setVisibility(View.GONE);
            entrepreneurCommentLabel.setVisibility(View.GONE);
            contractorCommentLabel.setVisibility(View.GONE);
        } else {
