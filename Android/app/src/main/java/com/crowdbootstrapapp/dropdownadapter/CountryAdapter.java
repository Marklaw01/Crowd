package com.crowdbootstrapapp.dropdownadapter;
...
public class CountryAdapter extends BaseAdapter{
    ...
    ArrayList<CountryObject> playListMap;
    boolean status;
    int pos = 0;
    View convertView1;
    Context context;

    public CountryAdapter(Context context, int textViewResourceId, ArrayList<CountryObject> playListMap) {
