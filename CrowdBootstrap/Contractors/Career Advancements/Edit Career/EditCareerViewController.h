...
#define CAREER_FOLLOW_SECTION_INDEX           0
#define CAREER_TITLE_SECTION_INDEX           1
#define CAREER_DESCRIPTION_SECTION_INDEX  2
#define CAREER_START_DATE_SECTION_INDEX  3
#define CAREER_END_DATE_SECTION_INDEX    4
#define CAREER_TARGET_MARKET_KEYWORDS_SECTION_INDEX    5
#define CAREER_KEYWORDS_SECTION_INDEX    6
#define CAREER_INDUSTRY_KEYWORDS_SECTION_INDEX  7
#define CAREER_IMAGE_SECTION_INDEX       8
#define CAREER_DOCUMENT_SECTION_INDEX    9
#define CAREER_AUDIO_SECTION_INDEX       10
#define CAREER_VIDEO_SECTION_INDEX       11
...
enum {
    CAREER_TARGET_MARKET_KEYWORDS_SELECTED = 5,
    CAREER_KEYWORDS_SELECTED = 6,
    CAREER_INDUSTRY_KEYWORDS_SELECTED = 7
};
...
#define kEditCareer_SuccessMessage                @"Career has been updated Successfully."
...
@interface EditCareerViewController : UIViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate, TLTagsControlDelegate, UISearchBarDelegate>
{
    // --- IBOutlets ---
    ...
    IBOutlet UIView                           *careerDataView;
