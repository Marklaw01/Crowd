            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div role="tabpanel" class="about-section">
                ...
                <ul id="tabbing" class="nav aboutTab nav-tabs" role="tablist">
                  ...
                  <?php 
                    //echo $this->Html->link("BASIC",ARRAY('controller'=>'contractors','action'=>'MyProfile'),ARRAY('class'=>"focus",'aria-controls'=>'about', 'role'=>'tab', 'data-toggle'=>'tab1'));
                  ...
                  <?php 
                    ...
                    //echo $this->Html->link("PROFESSIONAL",ARRAY('controller'=>'contractors','action'=>'ProfessionalProfile','#professional'),ARRAY('class'=>"",'aria-controls'=>'about', 'role'=>'tab', 'data-toggle'=>'tab1'));?>
                  ...
                  //echo $this->Html->link("STARTUPS",ARRAY('controller'=>'startups','action'=>'ListStartup'),ARRAY('class'=>"",'aria-controls'=>'about', 'role'=>'tab', 'data-toggle'=>'tab1'));?>
...
// Ajax for states list     
 $('#country').change(function(){
    var val = $(this).val();
    $.ajax({ 
    url: "<?php echo $this->Url->build(["Controller" => "Contractors","action" => "getOptionsList"]);?>",
    data: {countryId:val},
    type : 'POST',
    cache: false,
...
$(document).ready(function(){
 ...
 $("#remove_image").on('click','.cross_image',function(){
    ...
    $.ajax({ 
    url: "<?php echo $this->Url->build(["Controller" => "Contractors","action" => "remove_image"]);?>",
