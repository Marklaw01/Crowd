          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li> <?php
                    echo $this->Html->link('Software', array('controller'=>'Softwares','action'=>'index'), array('escape'=>false));
                ?></li>
                <li class="active">Edit Software</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Software Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Software Title','class' => 'form-control','type'=>'text','value'=>$fundDetails->title));
                ?>
                <?php 
              ...
              <label>Software Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Software Description','class' => 'form-control','value'=>$fundDetails->description));
                 ?>
                 <?php 
              ...
              <div class="form-group">
              <label>Software Availability Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Software Availability Start Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->start_date));
                ?>
                <?php 
              ...
              <div class="form-group">
              <label>Software Availability End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Software Availability End Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->end_date));
                ?>
                <?php 
              ...
              <div class="form-group">
              <label>Software Keywords</label>
                <?php
                  //$FK= explode(',', $fundDetails->keywords_id);
                  //echo $this->Form->input('keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'keywords_id','multiple'=>true,'type'=>'select','title'=>"No Software Keywords Added",'value'=>$FK, 'options'=>$keywordsLists));
                ?> 
