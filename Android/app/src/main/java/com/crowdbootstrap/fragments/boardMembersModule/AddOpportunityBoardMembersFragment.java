 ...
 */
public class AddOpportunityBoardMembersFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddOpportunityBoardMembersFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyOpportunityBoardMembersFragments();
                    case 1:
                        return new ArchivedBoardMembersFragment();
                    case 2:
                        return new DeactivatedBoardMembersFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
