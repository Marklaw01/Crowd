  ...
  <div class="row">
    <div class="col-lg-12 ">
      <ol class="breadcrumb">
        ...
        ?></li>
        <li class="active">Find Audio Video</li>
      </ol>
    </div>
  </div>
  <!-- header ends --> 
                ...
                <?php $ss=0; foreach($myFundsLists AS $myFundsList){ $ss++; ?>
                    <tr>
                      ...
                      <td>
                        ...
                        echo $this->Html->link('View',['controller'=>'AudioVideos','action'=>'view',$fundId],['class'=>'fa fa-angle-double-right']);
                        ?>
                      </td>
