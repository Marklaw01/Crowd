...
#define HARDWARE_FOLLOW_SECTION_INDEX           0
#define HARDWARE_TITLE_SECTION_INDEX           1
#define HARDWARE_DESCRIPTION_SECTION_INDEX  2
#define HARDWARE_START_DATE_SECTION_INDEX  3
#define HARDWARE_END_DATE_SECTION_INDEX    4
#define HARDWARE_TARGET_MARKET_KEYWORDS_SECTION_INDEX    5
#define HARDWARE_KEYWORDS_SECTION_INDEX    6
#define HARDWARE_INDUSTRY_KEYWORDS_SECTION_INDEX  7
#define HARDWARE_IMAGE_SECTION_INDEX       8
#define HARDWARE_DOCUMENT_SECTION_INDEX    9
#define HARDWARE_AUDIO_SECTION_INDEX       10
#define HARDWARE_VIDEO_SECTION_INDEX       11
...
enum {
    HARDWARE_TARGET_MARKET_KEYWORDS_SELECTED = 5,
    HARDWARE_KEYWORDS_SELECTED = 6,
    HARDWARE_INDUSTRY_KEYWORDS_SELECTED = 7
};
...
#define kEditHardware_SuccessMessage           @"Hardware has been updated Successfully."
...
@interface EditHardwareViewController : UIViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate, TLTagsControlDelegate, UISearchBarDelegate>
{
    // --- IBOutlets ---
    ...
    IBOutlet UIView                           *hardwareDataView;
