 ...
 */
public class RequestAudioVideoFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public RequestAudioVideoFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity) getActivity()).setActionBarTitle("Audio/Video");
        ...
        startDateTV.setText("Auidio/Video Availability Start Date");
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    create(map, Constants.CREATE_AUDIO_VIDEO_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
                    ...
                    if (result.equals(Constants.NOINTERNET)) {
                        ...
                        if (result.isEmpty()) {
                            ...
                            try {
                                ...
                                if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                                    pathofmedia.clear();
                                    Toast.makeText(getActivity(), "Your Audio/Video resource is created successfully.", Toast.LENGTH_LONG).show();
