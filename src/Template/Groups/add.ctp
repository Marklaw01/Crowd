          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Group Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Group Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Group Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Group Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Group Availability Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Group Availability Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Group Availability End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Group Availability End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Group Keywords</label>
                <?php
                  //echo $this->Form->input('keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'keywords_id','multiple'=>true,'type'=>'select','title'=>"No Group Keywords Added", 'options'=>$keywordsLists));
                ?> 
