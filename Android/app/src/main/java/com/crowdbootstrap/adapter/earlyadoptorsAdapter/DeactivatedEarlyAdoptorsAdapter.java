package com.crowdbootstrap.adapter.earlyadoptorsAdapter;
...
import com.crowdbootstrap.fragments.earlyAdoptorsModule.EarlyAdoptersLikeDislikeFragment;
 ...
 */
public class DeactivatedEarlyAdoptorsAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedEarlyAdoptorsAdapter(Context context, ArrayList<FundsObject> list) {
