 ...
 */
public class DeactivatedCareerAdvancementAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedCareerAdvancementAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        try {
           ...
           // holder.dislikeBtn.setOnClickListener(this);
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this tool?", Constants.CAREERADVANCEMENT_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
