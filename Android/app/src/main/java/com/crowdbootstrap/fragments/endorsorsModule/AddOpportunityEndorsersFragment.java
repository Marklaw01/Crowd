 ...
 */
public class AddOpportunityEndorsersFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddOpportunityEndorsersFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyOpportunityEndorsersFragments();
                    case 1:
                        return new ArchivedEndorsersFragment();
                    case 2:
                        return new DeactivatedEndorsersFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
