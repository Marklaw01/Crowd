          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Select Keywords</label>
                  ...
                  <?php
                      echo $this->Form->input('keywordsTwo', ARRAY('label' => false, 'div' => false, 'class' => 'form-control  scrollable custom-select', 'id' => 'standard_forum','type'=>'select','title'=>'Keywords','multiple'=>false, 'size'=>'','empty'=>'Select Keyword', 'options'=>$Keywords));
                  ?>  
              ...
              <?php
                ...
                <div class="form-group  pull-right">
                      <?= $this->Form->button('Add Forum',['class'=> 'customBtn blueBtn']) ?>
                </div>
             </div>
          </div>
          <?= $this->Form->end() ?>  
