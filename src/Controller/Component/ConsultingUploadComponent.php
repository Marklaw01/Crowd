...
class ConsultingUploadComponent extends Component
{
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('ConsultingInterestKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('ConsultingTargetKeywords');
		...
		* * * * */
		public function isFollowedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('ConsultingFollowers');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['consulting_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function isCommitedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('ConsultingCommitments');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['consulting_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function getCommitCount($fundId=null)
		{
			...
			$FundDislikes = TableRegistry::get('ConsultingCommitments');
			$likelists= $FundDislikes->find('all',['conditions'=>['consulting_id' => $fundId]]);
	    ...
	    ****/
	    ...
	    public function uploadImage($files = null) 
	    {
		    ...
		    if(!empty($files)){
                ...
                $path = WWW_ROOT . "img/consulting/"; // Upload directory
                $imgCamp='';
                $errors='';
