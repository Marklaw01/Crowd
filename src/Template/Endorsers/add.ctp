          ...
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Add Endorser</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Endorsement Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Endorsement Title','class' => 'form-control','type'=>'text'));
                ?>
                <?php 
              ...
              <label>Endorsement Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Endorsement Description','class' => 'form-control'));
                 ?>
                 <?php 
              ...
              <label>Endorsement Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Endorsement Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Endorsement End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Endorsement End Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
              ...
              <label>Endorsement Keywords</label>
                <?php
                  //echo $this->Form->input('endorsor_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'endorsor_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Endorsement Keywords Added", 'options'=>$keywordsLists));
                ?> 
              ...
              <label>Interest Keywords</label>
                <?php
                  //echo $this->Form->input('endorsor_interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'endorsor_interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added", 'options'=>$intrestKeywordLists));
                ?> 
