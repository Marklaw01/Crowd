 ...
 */
public class RequestConsultingFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    private LinearLayout consultingLayout;
    private TextView targetMarketTV;
    private String enteredType;


    public RequestConsultingFragment() {
        super();
    }
    ...
    private void setStartDate() {
        try {
            ...
            et_d_assignment_startdate.setText(sdf.format(myCalendarInvestmentStartDate.getTime()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity) getActivity()).setActionBarTitle("Consulting");
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    create(map, Constants.CREATE_CONSULTING_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
                    ...
                    if (result.equals(Constants.NOINTERNET)) {
                        ...
                        if (result.isEmpty()) {
                            ...
                            try {
                                ...
                                if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                                    pathofmedia.clear();
                                    Toast.makeText(getActivity(), "Your Consulting assignment is created successfully.", Toast.LENGTH_LONG).show();
