 ...
 */
public class AddResourceInformationFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceInformationFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesInformationFragments();
                    case 1:
                        return new ArchivedInformationFragment();
                    case 2:
                        return new DeactivatedInformationFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
