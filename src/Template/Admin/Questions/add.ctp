<div id="page-content-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 ">
          <h1 class="page-header"><i class="fa fa-users"></i>Add Question 
          </h1>
          <?php
			     echo $this->Html->link('Back', array('controller'=> 'Questions','action'=>'index'), array('escape'=>false, 'title'=>'Back','class'=>'btn redColor'));
		      ?>
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-8 col-sm-12 ">
                        ...
                        <label>Questions Name</label>
                            <?php
                              echo $this->Form->input('name', ARRAY('label' => false, 'div' => false,'error' => false, 'class' => 'form-control','placeholder'=>'Questions Name',));
                           ?>
                           <?php 
