...
@synthesize tapDelegate,deleteDelegate;
...
- (void)commonInit {
    ...
    //tagInputField.layer.cornerRadius = 5;
...
- (void)deleteTagButton:(UIButton *)sender {
    ...
    NSLog(@"view tag: %ld",(long)view.superview.tag) ;
   // [view removeFromSuperview];
    
    NSInteger index = [tagSubviews_ indexOfObject:view];
    
    [deleteDelegate tagsControl:view withTagControlIndex:view.superview.tag removedFromIndex:index] ;
