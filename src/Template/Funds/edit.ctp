          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Fund's Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>"Fund's Title",'class' => 'form-control','type'=>'text','value'=>$fundDetails->title));
                ?>
                <?php 
              ...
              <label>Fund's Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>"Fund's Description",'class' => 'form-control','value'=>$fundDetails->description));
                 ?>
                 <?php 
              ...
              <label>Fund's Managers</label>
                <?php
                  //$FM= explode(',', $fundDetails->managers_id);
                  //echo $this->Form->input('managers_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'managers_id','multiple'=>true,'type'=>'select','title'=>"No Fund's Managers Added",'value'=>$FM, 'options'=>$managerLists));
                ?> 
                    ...
                    <?php 
                      if(isset($_POST['submit'])){
                        if(isset($_POST['managers_id'])){
                          ...
                          $skey11=explode(',', $fundDetails->managers_id);
                        }
              ...
              <label>Sponsors</label>
                <?php
                  //$FS= explode(',', $fundDetails->sponsors_id);
                  //echo $this->Form->input('sponsors_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'sponsors_id','multiple'=>true,'type'=>'select','title'=>"No Sponsors Added",'value'=>$FS, 'options'=>$sponsorsLists));
                ?> 
                      ...
                      <?php 
                        if(isset($_POST['submit'])){
                          if(isset($_POST['sponsors_id'])){
                            ...
                            $skey12=explode(',', $fundDetails->sponsors_id);
                          }
              ...
              <label>Industry</label>
                <?php
                  //$FI= explode(',', $fundDetails->indusries_id);
                  //echo $this->Form->input('indusries_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'indusries_id','multiple'=>true,'type'=>'select','title'=>"No Industry Added",'value'=>$FI, 'options'=>$industryLists));
                ?> 
                      ...
                      <?php 
                        if(isset($_POST['submit'])){
                          if(isset($_POST['indusries_id'])){
                            ...
                            $skey13=explode(',', $fundDetails->indusries_id);
                          }
              ...
              <label>Portfolio Companies</label>
                <?php
                 //$FP= explode(',', $fundDetails->portfolios_id);
                 // echo $this->Form->input('portfolios_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'portfolios_id','multiple'=>true,'type'=>'select','title'=>"No Portfolio Companies Added",'value'=>$FP, 'options'=>$portfolioLists));
                ?> 
                      ...
                      <?php 
                        if(isset($_POST['submit'])){
                          if(isset($_POST['portfolios_id'])){
                            ...
                            $skey14=explode(',', $fundDetails->portfolios_id);
                          }
              ...
              <label>Investment Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Investment Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->start_date));
                ?>
                <?php 
              ...
              <label>Investment End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Investment Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->end_date));
                ?>
                <?php 
              ...
              <label>Fund's Investment Closure Date</label>
                <?php
                  echo $this->Form->input('close_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>"Fund's Investment Closure Date",'maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->close_date));
                ?>
                <?php 
              ...
              <label>Keywords</label>
                <?php
                  ...
                  //echo $this->Form->input('keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'keywords_id','multiple'=>true,'type'=>'select','title'=>"No Keywords Added",'value'=>$FK, 'options'=>$keywordsLists));
                ?> 
                      ...
                      <?php 
                        if(isset($_POST['submit'])){
                          if(isset($_POST['keywords_id'])){
                            ...
                            $skey15=explode(',', $fundDetails->keywords_id);
                          }
