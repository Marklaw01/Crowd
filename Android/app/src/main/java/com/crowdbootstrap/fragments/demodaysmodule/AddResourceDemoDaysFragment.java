 ...
 */
public class AddResourceDemoDaysFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceDemoDaysFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesDemoDaysFragments();
                    case 1:
                        return new ArchivedDemoDaysFragment();
                    case 2:
                        return new DeactivatedDemoDaysFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
