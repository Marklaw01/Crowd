 ...
 */
public class DemoDaysFragment extends Fragment{

    private TextView dummyText;
    public DemoDaysFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity)getActivity()).setActionBarTitle(getString(R.string.demo_days));
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new SearchResourcesDemoDaysFragment();
                    case 1:
                        return new AddResourceDemoDaysFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
