...
import com.staging.fragments.consultingModule.ConsultingComittersFragment;
 ...
 */
public class ConsultingAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ConsultingAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
