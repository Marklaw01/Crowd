<div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                <li class="active">Edit Meet Up</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 ">
              ...
              <label>Meet Up Title</label>
                <?php
                  echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Meet Up Title','class' => 'form-control','type'=>'text','value'=>$fundDetails->title));
                ?>
                <?php 
              ...
              <label>Meet Up Description</label>
                 <?php
                    echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Meet Up Description','class' => 'form-control','value'=>$fundDetails->description));
                 ?>
                 <?php 
              ...
              <div class="form-group">
              <label>Meet Up Availability Start Date</label>
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Meet Up Availability Start Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->start_date));
                ?>
                <?php 
              ...
              <div class="form-group">
              <label>Meet Up Availability End Date</label>
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Meet Up Availability End Date','maxlength' => '50','class'=> 'testpicker form-control','value'=>$fundDetails->end_date));
                ?>
                <?php 
              ...
              <label>Add Forum</label>
                <?php
                  echo $this->Form->input('forum_id', array('options'=>$forums, 'label'=>false,'class' => 'form-control  scrollable custom-select','empty'=>'Select your forum','default'=>$fundDetails->forum_id)); 
                ?>
                <?php 
                      echo $this->Form->error('forum_id', null, array('class' => 'error-message'));
                ?>
              </div>


              <div class="form-group">
              <label>Meet Up Access </label>
                <?php
                  $access_level = array('1' => 'Group' , '2' => 'Connections', '3' =>'Public' );
                  echo $this->Form->input('access_level', array('options'=>$access_level, 'label'=>false,'class' => 'form-control  scrollable custom-select','empty'=>'Select Access Level','default'=>$fundDetails->access_level)); 
                ?>
                <?php 
                      echo $this->Form->error('access_level', null, array('class' => 'error-message'));
                ?>
              </div>

             <div class="form-group">
              <label>Meet Up Notification </label>
                <?php
                  $notification = array('1' => 'Group' , '2' => 'Connections');
                  echo $this->Form->input('send_notifications', array('options'=>$notification, 'label'=>false,'class' => 'form-control  scrollable custom-select','empty'=>'Select Notification','default'=>$fundDetails->send_notifications)); 
                ?>
                <?php 
                      echo $this->Form->error('send_notifications', null, array('class' => 'error-message'));
                ?>
              </div>
              ...
              <div class="form-group">
              <label>Meet Up Keywords</label>
                <?php
                 //$FK= explode(',', $fundDetails->keywords_id);
                 // echo $this->Form->input('keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'keywords_id','multiple'=>true,'type'=>'select','title'=>"No Meet Up Keywords Added",'value'=>$FK, 'options'=>$keywordsLists));
                ?> 
                    ...
                    <?php 
                      if(isset($_POST['submit'])){
                          if(isset($_POST['keywords_id'])){
                            $skey31= $_POST['keywords_id'];
                          }else{
                            $skey31=explode(',', $fundDetails->keywords_id);
                          }
                ...
                <select name="keywords_id[]" multiple="" id="hiddenKey31" style="display: none;">
                    <?php
                      if(!empty($skey31[0])){
              ...
              <label>Interest Keywords</label>
                <?php
                  //$FM= explode(',', $fundDetails->interest_keywords_id);
                  //echo $this->Form->input('interest_keywords_id', ARRAY('label' => false, 'div' => false, 'error' => false, 'class' => 'validate[required]form-control selectpicker form-control show-tick','id' => 'interest_keywords_id','multiple'=>true,'type'=>'select','title'=>"No Interest Keywords Added",'value'=>$FM, 'options'=>$intrestKeywordLists));
                ?> 
                ...
                <span class="form-control textAreaKeyword" id="selectedResult22">
                    ...
                    <?php 
                      if(isset($_POST['submit'])){
                          if(isset($_POST['interest_keywords_id'])){
                            $skey22= $_POST['interest_keywords_id'];
                          }else{
                            $skey22=explode(',', $fundDetails->interest_keywords_id);
                          }
                ...
                <select name="interest_keywords_id[]" multiple="" id="hiddenKey22" style="display: none;">
                    <?php
                      if(!empty($skey22[0])){
                ...
                <?php 
                    echo $this->Form->error('interest_keywords_id', null, array('class' => 'error-message'));
                ?>
                <script type="text/javascript">
                  $(function() {
