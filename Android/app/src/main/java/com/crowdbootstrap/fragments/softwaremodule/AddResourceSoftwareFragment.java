 ...
 */
public class AddResourceSoftwareFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceSoftwareFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesSoftwareFragments();
                    case 1:
                        return new ArchivedSoftwareFragment();
                    case 2:
                        return new DeactivatedSoftwareFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
