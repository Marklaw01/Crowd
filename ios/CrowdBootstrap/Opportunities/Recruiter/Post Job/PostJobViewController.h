...
#define kAddJob_SuccessMessage    @"Job added Successfully."

@interface PostJobViewController : UIViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate, UIPickerViewDataSource,UIPickerViewDelegate, TLTagsControlDelegate>
{
    // --- IBOutlets ---
