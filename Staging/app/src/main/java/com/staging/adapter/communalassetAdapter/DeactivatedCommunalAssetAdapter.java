 ...
 */
public class DeactivatedCommunalAssetAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedCommunalAssetAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        try {
           ...
           // holder.dislikeBtn.setOnClickListener(this);
            ...
            holder.tv_archive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(position, "Do you want to activate this opportunity?", Constants.COMMUNALASSET_ACTIVATE_URL);
                }
            });
        } catch (Exception e) {
