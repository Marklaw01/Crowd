 ...
 */
public class UpdateRequestBoardMembersFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public UpdateRequestBoardMembersFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        searchBoardMembers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BoardMembersSearchFragment betaTestersSearchFragment = new BoardMembersSearchFragment();
            ...
            if (tag.equals(Constants.BOARD_MEMBERS_KEYWORDS_LIST_TAG)) {
                ...
                try {
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        //fund managers
                        preChecked(jsonObject.getJSONArray("board_interest_keywords"), interestedKeywordsList, R.id.et_interestKeywords);


                        //fund sponsors
                        preChecked(jsonObject.getJSONArray("board_oppertunity_keywords"), keywordsList, R.id.et_keywords);
