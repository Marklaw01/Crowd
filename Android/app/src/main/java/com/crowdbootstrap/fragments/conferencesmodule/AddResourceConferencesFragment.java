 ...
 */
public class AddResourceConferencesFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceConferencesFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesConferencesFragments();
                    case 1:
                        return new ArchivedConferencesFragment();
                    case 2:
                        return new DeactivatedConferencesFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
