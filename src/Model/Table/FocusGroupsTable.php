...
class FocusGroupsTable extends Table
{
    public function initialize(array $config)
    { 
        parent::initialize($config);
        $this->addBehavior('Timestamp');
        $this->table('focus_groups');
    ...
    public function validationDefault(Validator $validator)
    {
            ...
            $validator
                ->requirePresence('focus_group_interest_keywords_id', 'create')
                ->notEmpty('focus_group_interest_keywords_id','Please select industries.');


            $validator
                ->requirePresence('focus_group_keywords_id', 'create')
                ->notEmpty('focus_group_keywords_id','Please select keywords.');
