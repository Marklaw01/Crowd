 ...
 */
public class AddOpportunityGroupsFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddOpportunityGroupsFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyOpportunityGroupsFragments();
                    case 1:
                        return new ArchivedGroupsFragment();
                    case 2:
                        return new DeactivatedGroupsFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
