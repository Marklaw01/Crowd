...
import com.crowdbootstrap.activities.IndependentContractorActivity;
import com.crowdbootstrap.activities.LeanStartupRoadmap;
import com.crowdbootstrap.activities.LoginActivity;
import com.crowdbootstrap.activities.OurMissionActivity;
import com.crowdbootstrap.activities.OurValuesActivity;
import com.crowdbootstrap.activities.OurVisionActivity;
...
public class LoginHomeInfoFragment extends Fragment implements View.OnClickListener {
        ...
        try {
            ...
            tv_howItWorks.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((LoginActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.howItWorks));
                }
            });
