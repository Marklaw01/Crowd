 ...
 */
public class AddResourceLaunchDealsFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceLaunchDealsFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesLaunchDealsFragments();
                    case 1:
                        return new ArchivedLaunchDealsFragment();
                    case 2:
                        return new DeactivatedLaunchDealsFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
