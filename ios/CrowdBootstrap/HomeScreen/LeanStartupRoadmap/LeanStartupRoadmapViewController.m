...
//    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:roadmap.sampleLink]];
}

// Show PDF Sample
- (IBAction)btnTemplateClicked:(id)sender {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:roadmap.templateLink]];
}
