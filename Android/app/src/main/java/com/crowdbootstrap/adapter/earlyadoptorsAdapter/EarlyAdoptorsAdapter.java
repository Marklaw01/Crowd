 ...
 */
public class EarlyAdoptorsAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public EarlyAdoptorsAdapter(Context context, ArrayList<FundsObject> list, String fragmentName) {
