 ...
 */
public class RequestBetaTesterFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public RequestBetaTesterFragment() {
        super();
    }
