                ...
                <div class="tab-content">
                 <!-- 1Tab-->
                  ...
                  <?php if($userApprovStatus == 1){?>   
                     <div class="links"> 
                           <?php
                              $group = $this->Url->build(["controller" => "Messages","action" => "chat"]);
                           ?>
                           ...
                           <?php if($UserRoleId == 1 or $UserRoleId == 2 or $UserRoleId == 3){?>
                            ...
                            <tr>
                                ...
                                $startUserId= $startupDetails['user_id'];
                                   if(!empty($startupDetails['user']['entrepreneur_basic']['first_name'])){
                                    ...
                                    $entrName= $startupDetails['user']['entrepreneur_basic']['first_name'].' '.$startupDetails['user']['entrepreneur_basic']['last_name'];
                                      ...
                                      $entrName= $startupDetails['user']['first_name'].' '.$startupDetails['user']['last_name'];
