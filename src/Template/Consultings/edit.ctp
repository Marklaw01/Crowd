  ...
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 ">
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('title', ARRAY('label' => false, 'div' => false, 'error' => false, 'id' => '','placeholder'=>'Consulting Project Title','class' => 'form-control','type'=>'text','value'=>$fundDetails->title));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('overview', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Project Overview','class' => 'form-control','value'=>$fundDetails->overview));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('description', ARRAY('label' => false, 'div' => false,'error' => false,'type' => 'textarea','placeholder'=>'Description/Condition','class' => 'form-control','value'=>$fundDetails->description));
            ?>
            <?php 
              ...
              <?php 
                if(isset($_POST['submit'])){
                    if(isset($_POST['target_keywords_id'])){
                      ...
                      $skey31=explode(',', $fundDetails->target_keywords_id);
                    }
              ...
              <?php 
                if(isset($_POST['submit'])){
                    if(isset($_POST['interest_keyword_id'])){
                      ...
                      $skey22=explode(',', $fundDetails->interest_keyword_id);
                    }
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('client_overview_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Date to Distribute Project Overview','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->client_overview_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('bid_intent_deadline_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Deadline for Intent to Bid','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->bid_intent_deadline_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('requirement_distribute_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Date to Distribute Project Requirements','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->requirement_distribute_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('bid_commitment_deadline_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Deadline for commitment to bid','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->bid_commitment_deadline_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('question_deadline_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Deadline for Questions','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->question_deadline_date));
            ?>
            <?php 
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 ">
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('answer_target_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Date for Answers','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->answer_target_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('proposal_submit_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Deadline for Proposals','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->proposal_submit_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('bidder_presentation_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Date for Bidder Presentations','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->bidder_presentation_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('project_award_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Date to Award the Project','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->project_award_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('project_start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Project Start Date','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->project_start_date));
            ?>
            <?php 
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('project_complete_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'due_date','type'=>'text','placeholder'=>'Target Project End Date','maxlength' => '50','class'=> 'testTimePicker form-control','value'=>$fundDetails->project_complete_date));
            ?>
            <?php 
