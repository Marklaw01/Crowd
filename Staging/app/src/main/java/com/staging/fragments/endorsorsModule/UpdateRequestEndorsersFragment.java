 ...
 */
public class UpdateRequestEndorsersFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    private Button btnCreate,SearchEndorser;
    ...
    public UpdateRequestEndorsersFragment() {
        super();
    }
    ...
    public void onResume() {
        ...
        if(viewFiles == true){
            ...
            if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                ...
                AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.ENDORSOR_KEYWORDS_LIST_TAG, Constants.ENDORSOR_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                a.execute();
            } else {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        titleTV.setText("Endorsement Title");
        keywordTV.setText("Endorsement Keywords");
        ...
        SearchEndorser = (Button) rootView.findViewById(R.id.searchBoardMember);
        SearchEndorser.setText("Search Recommended Endorsers");
        SearchEndorser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle bundlesearch = new Bundle();
                bundlesearch.putString(Constants.FUND_ID, fund_id);
                EndorsersSearchFragment betaTestersSearchFragment = new EndorsersSearchFragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                map.put("endorsor_id", fund_id);
                map.put("title", et_title.getText().toString().trim());
                map.put("description", et_description.getText().toString().trim());
                map.put("endorsor_interest_keywords_id", selectedInterestedKeywordsId);
                map.put("endorsor_keywords_id", selectedKeywordsIDs);
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    update(map, Constants.UPDATE_ENDORSOR_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
    ...
    public void onTaskComplete(String result, String tag) {
        if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
            ...
            if (tag.equals(Constants.ENDORSOR_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    keywordsList.clear();
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        for (int i = 0; i < jsonObject.optJSONArray("endorsor_keyword_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("endorsor_keyword_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("endorsor_keyword_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
                            keywordsList.add(obj);
                        }
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.ENDORSOR_INTEREST_KEYWORDS_LIST_TAG, Constants.ENDORSOR_INTEREST_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.ENDORSOR_INTEREST_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        //((HomeActivity) getActivity()).dismissProgressDialog();
                        for (int i = 0; i < jsonObject.optJSONArray("endorsor_interest_keyword_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("endorsor_interest_keyword_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("endorsor_interest_keyword_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
                            interestedKeywordsList.add(obj);
                        }
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.ENDORSOR_TARGET_MARKET_LIST_TAG, Constants.ENDORSOR_TARGET_MARKET_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.ENDORSOR_TARGET_MARKET_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        for (int i = 0; i < jsonObject.optJSONArray("endorsor_target_market_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("endorsor_target_market_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("endorsor_target_market_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
                        ...
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            ...
                            object.put("endorsor_id", fund_id);
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.ENDORSOR_DETAILS_TAG, Constants.ENDORSOR_DETAILS_URL, Constants.HTTP_POST_REQUEST, object);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.ENDORSOR_DETAILS_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        //fund managers
                        preChecked(jsonObject.getJSONArray("endorsor_interest_keywords_id"), interestedKeywordsList, R.id.et_interestKeywords);


                        //fund sponsors
                        preChecked(jsonObject.getJSONArray("endorsor_keywords_id"), keywordsList, R.id.et_keywords);
