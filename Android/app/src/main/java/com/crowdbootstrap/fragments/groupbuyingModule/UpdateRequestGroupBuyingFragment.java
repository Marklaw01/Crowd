 ...
 */
public class UpdateRequestGroupBuyingFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    private Button btnCreate, searchBoardMembers;
    ...
    public UpdateRequestGroupBuyingFragment() {
        super();
    }
    ...
    public void onResume() {
        ...
        if (viewFiles == true) {
            ...
            if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                ...
                AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.GROUP_BUYING_KEYWORDS_LIST_TAG, Constants.GROUP_BUYING_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                a.execute();
            } else {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        searchBoardMembers = (Button) rootView.findViewById(R.id.searchBoardMember);
        ...
        searchBoardMembers.setVisibility(View.GONE);
        searchBoardMembers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle bundleBoardMember = new Bundle();
                bundleBoardMember.putString(Constants.FUND_ID, fund_id);
                GroupBuyingSearchFragment betaTestersSearchFragment = new GroupBuyingSearchFragment();
                betaTestersSearchFragment.setArguments(bundleBoardMember);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                map.put("groupbuying_id", fund_id);
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    update(map, Constants.UPDATE_GROUP_BUYING_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
    ...
    public void onTaskComplete(String result, String tag) {
        if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
            ...
            if (tag.equals(Constants.GROUP_BUYING_KEYWORDS_LIST_TAG)) {
                ...
                try {
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.GROUP_BUYING_INTEREST_KEYWORDS_LIST_TAG, Constants.GROUP_BUYING_INTEREST_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.GROUP_BUYING_INTEREST_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.GROUP_BUYING_TARGET_MARKET_LIST_TAG, Constants.GROUP_BUYING_TARGET_MARKET_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.GROUP_BUYING_TARGET_MARKET_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
            ...
            } else if (tag.equals(Constants.GROUP_BUYING_DETAILS_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
