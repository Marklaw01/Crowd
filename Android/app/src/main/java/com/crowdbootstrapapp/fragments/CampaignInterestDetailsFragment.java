...
import com.crowdbootstrapapp.models.AudioObject;
 ...
 */
public class CampaignInterestDetailsFragment extends Fragment implements View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public CampaignInterestDetailsFragment() {
        super();
    }
    ...
    public void onResume() {
        ...
        try {
            titleText = getArguments().getString("CAMPAIGN_NAME");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_campaing_interest_details, container, false);
        ...
        try {
            ...
            if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                ((HomeActivity) getActivity()).showProgressDialog();
                Async a = new Async(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.CAMPAIGN_DETAILS_TAG, Constants.CAMPAIGN_DETAILS_URL + "?campaign_id=" + CAMPAING_ID + "&user_id=" + ((HomeActivity) getActivity()).prefManager.getString(Constants.USER_ID), Constants.HTTP_GET,"Home Activity");
                a.execute();
    ...
    public void onTaskComplete(String result, String tag) {
        try {
            if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
                ...
                if (tag.equalsIgnoreCase(Constants.CAMPAIGN_DETAILS_TAG)) {
                    ((HomeActivity) getActivity()).dismissProgressDialog();
                    ...
                    try {
                        ...
                        if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                            ...
                            et_startupName.setText(campaigndetail.optString("startup_name").trim());
                            ...
                            try {
                                ...
                                String fundRaisedFor = campaigndetail.optString("fund_raised_so_far").trim();
                                if (fundRaisedFor.length() == 0) {
                                    et_fundRaiseSoFor.setText(((HomeActivity) getActivity()).utilitiesClass.changeInUSCurrencyFormat("0"));
                                } else {
                                    et_fundRaiseSoFor.setText(((HomeActivity) getActivity()).utilitiesClass.changeInUSCurrencyFormat(campaigndetail.optString("fund_raised_so_far")));
                                }
                            ...
                            ImageLoader.getInstance().displayImage(Constants.APP_IMAGE_URL + "/" + campaigndetail.optString("campaign_image").trim(), image_roadmap, options);
                            ...
                            if (campaigndetail.getString("is_commited_by_user").trim().equalsIgnoreCase("0")) {
                                commited_by_user = false;
                                btn_commit.setText("Commit");
                                btn_commit.setBackground(getResources().getDrawable(R.drawable.blue_button));
                                //btn_commit.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
                            } else {
                                commited_by_user = true;
                                btn_commit.setText("UnCommit");
                                btn_commit.setBackground(getResources().getDrawable(R.drawable.gray_button));
                            }
                            ...
                            if (campaigndetail.has("keywords")) {
                                ...
                                et_keywords.setText("Target Market: " + stringBuilder.toString());
                            }
                            ...
                            if (campaigndetail.has("campaign_keywords")) {
                                ...
                                et_campaignKeywords.setText("Campaign Keywords: " + stringBuilderCampaign.toString());
                            }
                ...
                } else if (tag.equalsIgnoreCase(Constants.UNCOMMIT_CAMPAIGN_TAG)) {
                    //((HomeActivity) getActivity()).dismissProgressDialog();
                    ...
                    try {
                        ...
                        if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                            Toast.makeText(getActivity(), "Successfully UnCommitted Campaign", Toast.LENGTH_LONG).show();
                            btn_commit.setText("Commit");
                            btn_commit.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));

                        } else if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_ERROR_STATUS_CODE)) {
                            Toast.makeText(getActivity(), "You Cannot UnCommitted Campaign", Toast.LENGTH_LONG).show();
                            btn_commit.setText("UnCommit");
                            btn_commit.setBackgroundColor(getResources().getColor(R.color.darkGrey));
                        }
                ...
                } else if (tag.equalsIgnoreCase(Constants.FOLLOW_CAMPAIGN_TAG)) {
                    ((HomeActivity) getActivity()).dismissProgressDialog();
                    ...
                    try {
                        ...
                        if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                            ...
                            if (jsonObject.optString("message").equalsIgnoreCase("can\\\"t unfollow")) {
                                cbx_Follow.setText("UnFollow");
                                followChecked = true;

                                cbx_Follow.setBackgroundColor(getResources().getColor(R.color.darkGrey));
                                followChecked = false;
                            } else if (jsonObject.optString("message").equalsIgnoreCase("successfully followed")) {
                                followChecked = true;

                                cbx_Follow.setText("UnFollow");
                                cbx_Follow.setBackgroundColor(getResources().getColor(R.color.darkGrey));
                                followChecked = false;
                            } else if (jsonObject.optString("message").equalsIgnoreCase("successfully unfollowed")) {
                                followChecked = true;
