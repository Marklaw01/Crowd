 ...
 */
public class BetaTestsFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public BetaTestsFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyBetaTestFragments();
                    case 1:
                        return new ArchivedBetaTestFragment();
                    case 2:
                        return new DeactivatedBetaTestFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.myBetaTest);
                case 1:
