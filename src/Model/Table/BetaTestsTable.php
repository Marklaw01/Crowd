...
class BetaTestsTable extends Table
{
    public function initialize(array $config)
    { 
        parent::initialize($config);
        $this->addBehavior('Timestamp');
        $this->table('beta_tests');
    ...
    public function validationDefault(Validator $validator)
    {
            ...
            $validator
                ->requirePresence('beta_interest_keywords_id', 'create')
                ->notEmpty('beta_interest_keywords_id','Please select industries.');


            $validator
                ->requirePresence('beta_test_keywords_id', 'create')
                ->notEmpty('beta_test_keywords_id','Please select keywords.');
