...
import com.crowdbootstrap.fragments.earlyAdoptorsModule.EarlyAdopterSearchFragment;
 ...
 */
public class UpdateRequestFocusGroupFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public UpdateRequestFocusGroupFragment() {
        super();
    }
    ...
    public void onResume() {
        ...
        if(viewFiles == true){
            if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                ...
                AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.FOCUS_GROUP_KEYWORDS_LIST_TAG, Constants.FOCUS_GROUP_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                a.execute();
            } else {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        searchFocusGroups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FocusGroupSearchFragment betaTestersSearchFragment = new FocusGroupSearchFragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                map.put("focus_group_id", fund_id);
                map.put("title", et_title.getText().toString().trim());
                map.put("description", et_description.getText().toString().trim());
                map.put("focus_group_interest_keywords_id", selectedInterestedKeywordsId);
                map.put("focus_group_keywords_id", selectedKeywordsIDs);
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    update(map, Constants.UPDATE_FOCUS_GROUP_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
    ...
    public void onTaskComplete(String result, String tag) {
        if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
            ...
            if (tag.equals(Constants.FOCUS_GROUP_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    keywordsList.clear();
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        for (int i = 0; i < jsonObject.optJSONArray("focus_group_keyword_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("focus_group_keyword_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("focus_group_keyword_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
                            keywordsList.add(obj);
                        }
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.FOCUS_GROUP_INTEREST_KEYWORDS_LIST_TAG, Constants.FOCUS_GROUP_INTEREST_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.FOCUS_GROUP_INTEREST_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        //((HomeActivity) getActivity()).dismissProgressDialog();
                        for (int i = 0; i < jsonObject.optJSONArray("focus_group_interest_keyword_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("focus_group_interest_keyword_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("focus_group_interest_keyword_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
                            interestedKeywordsList.add(obj);
                        }
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.FOCUS_GROUP_TARGET_MARKET_LIST_TAG, Constants.FOCUS_GROUP_TARGET_MARKET_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.FOCUS_GROUP_TARGET_MARKET_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        for (int i = 0; i < jsonObject.optJSONArray("focus_group_target_market_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("focus_group_target_market_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("focus_group_target_market_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
            ...
            } else if (tag.equals(Constants.FOCUS_GROUP_DETAILS_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        //fund managers
                        preChecked(jsonObject.getJSONArray("focus_group_interest_keywords_id"), interestedKeywordsList, R.id.et_interestKeywords);


                        //fund sponsors
                        preChecked(jsonObject.getJSONArray("focus_group_keywords_id"), keywordsList, R.id.et_keywords);
