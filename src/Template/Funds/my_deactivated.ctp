  ...
  <div class="row">
    <div class="col-lg-12 ">
      <ol class="breadcrumb">
        ...
        ?></li>
        <li class="active">Deactivated Funds</li>
      </ol>
    </div>
  </div>
  <!-- breadcrumb ends --> 
    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND FUNDS', array('controller'=>'Funds','action'=>'index'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'FUND/INVEST', array('controller'=>'Funds','action'=>'myFund'), array('escape'=>false,'class'=>'active'));
          ?>
      </div>
    </div>
  </div>
                 ...
                 <div class="listingContent">
                   ...
                   <div class="links alignRight">
                    ...
                    <?php 
                       ...
                       echo $this->Form->postLink('Activate',['action' => 'activateFund', base64_encode($myFundsList->id)],['id'=>'acPost'.$c,'class'=>'smallCurveBtnMsg greenBtn customBtnMsg']);
                    ?>
