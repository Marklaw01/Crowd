package com.crowdbootstrap.adapter.betatestadapters;
...
import com.crowdbootstrap.fragments.betatestmodule.BetaTestersLikeDislikeFragment;
 ...
 */
public class DeactivatedBetaTesterAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DeactivatedBetaTesterAdapter(Context context, ArrayList<FundsObject> list) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_Like:
                ...
                if (list.get(tagLikeId).getFund_likes() != 0) {
                    ...
                    Fragment likeFragment = new BetaTestersLikeDislikeFragment();
            ...
            case R.id.tv_dislike:
                ...
                if (list.get(tagDislikeId).getFund_dislike() != 0) {
                    ...
                    Fragment dislikeFragment = new BetaTestersLikeDislikeFragment();
