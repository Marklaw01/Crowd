            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div role="tabpanel" class="forum-section">
                ...
                <ul id="tabbing" class="nav nav-tabs campaignsTab" role="tablist">
                  ...
                  <li role="presentation" class="active"><a href="#startups" aria-controls="startups" role="tab" data-toggle="tab" onclick="location.href='<?php echo $startupForm;?>'">Startups</a></li>
                ...
                <div class="tab-content">
                 <!-- 1Tab-->
                  <div role="tabpanel" class="tab-pane active whiteBg" id="startups">
                    <ul class="contentListing startup_listing"> 

                        
                        <?php if(!empty($CurrentStartupLists)){
                        foreach($CurrentStartupLists as $forum){?>
                          ...
                          <li>
                           ...
                           <div class="listingContent">
                            ...
                            <div class="links alignRight">
                                 ...
                                 <!-- Delete Button Code -->
                                 <?php
                                 echo $this->Html->link('<i class="fa fa-eye"></i>View', array('controller'=>'Forums','action'=>'viewForumList',base64_encode($forum->id)), array('escape'=>false,'class'=>'smallCurveBtnMsg blueBtn customBtnMsg'));
                                 ?>
                      ...
                      <?php
                        $cc= count($CurrentStartupLists);
                            if(!empty($CurrentStartupLists)){
                      ?>
                              <nav class="pagingNav">
