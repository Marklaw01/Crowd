    ...
    <div class='col-lg-6 col-md-6 col-sm-6'>
      <div class="profileName">
          <?php
              ...
              echo $this->Html->link( $entrepre .'FIND LAUNCH DEALS', array('controller'=>'LaunchDeals','action'=>'index'), array('escape'=>false,'class'=>'navbar-brand'));
          ?>
          <?php
              $entrepre = '<i><img src="'.$this->request->webroot.'img/icons/Funds.png" alt=""></i>';
              echo $this->Html->link( $entrepre .'ADD LAUNCH DEAL', array('controller'=>'LaunchDeals','action'=>'myLaunchDeal'), array('escape'=>false,'class'=>'active'));
          ?>
      </div>
    </div>
  </div>
                ...
                <?php $ss=0; foreach($myFundsLists AS $myFundsList){ $ss++; ?>
                    <tr>
                      ...
                      <td>
                        ...
                        echo $this->Html->link('View',['controller'=>'LaunchDeals','action'=>'view',$fundId],['class'=>'fa fa-angle-double-right']);
                        ?>
                      </td>
