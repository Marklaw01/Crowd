package com.crowdbootstrap.helper;
...
/**
 * Created by sunakshi.gautam on 10/5/2016.
 */
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.material_grey_300));
