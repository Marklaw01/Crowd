          ...
          <div class="container-fluid">
            ...
            <div class="row form-group">
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <?php
                    echo $this->Form->input('first_name', ARRAY('label' => false, 'div' => false, 'class' => 'validate[required]form-control form-control', 'id' => 'txtPassword','placeholder'=>'First name','error' => false,'maxlength' => '50'));
                  ?>
                  <?php 
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <?php
                    echo $this->Form->input('last_name', ARRAY('label' => false, 'div' => false, 'class' => 'validate[required]form-control form-control', 'id' => 'txtPassword','placeholder'=>'Last name','error' => false,'maxlength' => '50'));
                  ?>
                  <?php 
