 ...
 */
public class RequestGroupBuyingFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {
    ...
    public RequestGroupBuyingFragment() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((HomeActivity) getActivity()).setActionBarTitle("Create Purchase Order");
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    create(map, Constants.CREATE_GROUP_BUYING_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
