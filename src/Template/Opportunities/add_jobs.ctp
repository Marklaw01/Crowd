  ...
  <?= $this->Form->create($jobs,['enctype' => 'multipart/form-data']) ?>  
    <div class="col-md-6 col-sm-6 col-xs-12"> 
        ...
        <div class="form-group">
            ...
            <select name="company_id" id="company" class="selectpicker form-control show-tick">
              ...
              <?php 
                foreach ($company as $key => $value) { ?>
                  <option value="<?php echo $value->sub_admin_detail->id;?>">
            ...
            <span class="error-message">You are not associated with any company. So you cannot post a job right now.</span>
            <?php } ?> 
        </div>
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('industry_id', ARRAY('label' => false, 'div' => false, 'class' => 'selectpicker form-control show-tick', 'id' => 'industry_id','type'=>'select','title'=>'Select Industry','data-size'=>'10', 'empty'=>'Select Industry','multiple'=>true, 'options'=>$jobindustry));
            ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('job_title', ARRAY('label' => false, 'div' => false, 'class' => 'validate[required,custom[onlyLetterSp]]form-control form-control', 'id' => 'job_title','placeholder'=>'Job Title'));
            ?>
        </div>
        ...
        <div class="form-group">
            <label>Role</label>
            <?php
              echo $this->Form->input('role', ARRAY('label' => false, 'div' => false, 'class' => 'validate[required,custom[onlyLetterSp]]form-control form-control', 'id' => 'role','placeholder'=>'Role', 'type'=>'text'));
            ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('job_type', ARRAY('label' => false, 'div' => false, 'class' => 'selectpicker form-control show-tick', 'id' => 'job_type','type'=>'select','title'=>'Select Job Type','data-size'=>'10', 'empty'=>'Select Job Type', 'options'=>$jobtype));
            ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('min_work_nps', ARRAY('label' => false, 'div' => false, 'class' => 'form-control', 'id' => 'min_work_nps','placeholder'=>'Minimum Work NPS','type'=>'text'));
            ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('country_id', ARRAY('label' => false, 'div' => false, 'class' => 'selectpicker1 form-control show-tick1', 'id' => 'country','type'=>'select','title'=>'Select Country','data-size'=>'10', 'empty'=>'Select Country', 'options'=>$countrylist));
            ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php
                echo $this->Form->input('state_id', ARRAY('label' => false, 'div' => false, 'class' => ' selectpicker1 form-control show-tick1', 'id' => 'state_id','type'=>'select','empty'=>'Select State'));
            ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php
              echo $this->Form->input('location', ARRAY('label' => false, 'div' => false, 'class' => 'validate[required,custom[onlyLetterSp]]form-control form-control', 'id' => 'role','placeholder'=>'Location', 'type'=>'text'));
            ?>
        </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12"> 
          ...
          <div class="form-group">
            <label>Travel</label>
            <?php
              echo $this->Form->input('travel', ARRAY('label' => false, 'div' => false, 'class' => 'form-control', 'id' => 'travel','placeholder'=>'Travel'));
            ?>
          </div>
          ...
          <div class="form-group">
                ...
                <?php
                  echo $this->Form->input('start_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'start_date','type'=>'text','placeholder'=>'Start Date','maxlength' => '50','class'=> 'testpicker form-control'));
                ?>
                <?php 
          ...
          <div class="form-group">
                ...
                <?php
                  echo $this->Form->input('end_date', ARRAY('label' => false, 'div' => false,'error' => false, 'id' => 'end_date','type'=>'text','placeholder'=>'End Date','class'=> 'testpicker form-control'));
                ?>
                <?php 
          ...
          <div class="form-group">
            <label>Skills</label>
            <?php
              echo $this->Form->input('skills', ARRAY('label' => false, 'div' => false, 'class' => 'selectpicker form-control show-tick', 'id' => 'skills','type'=>'select','title'=>'Skills','data-size'=>'10', 'empty'=>'Skills','multiple'=>true, 'options'=>$skill));
            ?>
          </div>
          ...
          <div class="form-group">
              ...
              <?php
                echo $this->Form->input('requirements', ARRAY('label' => false, 'div' => false, 'class' => 'validate[required,custom[onlyLetterSp]]form-control form-control', 'id' => 'requirements','placeholder'=>'Requirements'));
              ?>
          </div>
          ...
          <div class="form-group">
            ...
            <?php
              //echo $this->Form->input('posting_keywords', ARRAY('label' => false, 'div' => false, 'class' => 'selectpicker form-control show-tick', 'id' => 'posting_keywords','type'=>'select','title'=>'Select Job Posting Keywords','data-size'=>'10', 'empty'=>'Select Job Posting Keywords','multiple'=>true, 'options'=>$jobpostingkeyword));
            ?>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="form-group">
            <?= $this->Form->button('Submit',['name'=>'submit','class'=> 'customBtn blueBtn  pull-right']) ?>
          </div>
        </div>       
    </div> 
 <?= $this->Form->end() ?>
