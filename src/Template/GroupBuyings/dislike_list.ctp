<div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 ">
              <ol class="breadcrumb">
                ...
                ?></li>
                <li class="active">Purchase Order Dislike List</li>
              </ol>
            </div>
          </div>
          <!-- breadcrumb ends --> 
          <div class='row'>
            <div class='col-lg-12 col-md-12 col-sm-12 '>
             <div class="page_heading">
               <h1>Purchase Order Dislike List</h1> 
              </div>
            </div>
          ...
          <div class='row'>
            <div class='col-lg-12 col-md-12 col-sm-12 '>
                <?php 
                  echo $this->Html->link('Back', array('controller'=>'GroupBuyings', 'action' => 'view', base64_encode($Id)), array('escape'=>false,'class'=>'smallCurveBtn blueBtn customBtn'));
                ?>
            </div>
