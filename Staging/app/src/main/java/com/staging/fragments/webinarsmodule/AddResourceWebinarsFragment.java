 ...
 */
public class AddResourceWebinarsFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceWebinarsFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesWebinarsFragments();
                    case 1:
                        return new ArchivedWebinarsFragment();
                    case 2:
                        return new DeactivatedWebinarsFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
