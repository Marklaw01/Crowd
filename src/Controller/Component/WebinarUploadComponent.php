...
class WebinarUploadComponent extends Component
{
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('WebinarInterestKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('WebinarKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('WebinarTargetMarkets');
		...
		* * * * */
		public function isFollowedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('WebinarFollowers');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['webinar_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function isCommitedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('WebinarCommitments');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['webinar_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function getCommitCount($fundId=null)
		{
			...
			$FundDislikes = TableRegistry::get('WebinarCommitments');
			$likelists= $FundDislikes->find('all',['conditions'=>['webinar_id' => $fundId]]);
	    ...
	    ****/
	    ...
	    public function uploadImage($files = null) 
	    {
		    ...
		    if(!empty($files)){
                ...
                $path = WWW_ROOT . "img/webinar/"; // Upload directory
                $imgCamp='';
                $errors='';
