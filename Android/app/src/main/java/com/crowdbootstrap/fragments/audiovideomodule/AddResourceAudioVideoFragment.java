 ...
 */
public class AddResourceAudioVideoFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceAudioVideoFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesAudioVideoFragments();
                    case 1:
                        return new ArchivedAudioVideoFragment();
                    case 2:
                        return new DeactivatedAudioVideoFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
