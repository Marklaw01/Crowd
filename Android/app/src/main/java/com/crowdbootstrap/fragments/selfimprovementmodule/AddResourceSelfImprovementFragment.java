 ...
 */
public class AddResourceSelfImprovementFragment extends Fragment  {
    public TabLayout tabLayout;
    public NonSwipeableViewPager viewPager;
    public int int_items = 3;

    public AddResourceSelfImprovementFragment() {
        super();
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                switch (position) {
                    case 0:
                        return new MyResourcesSelfImprovementFragments();
                    case 1:
                        return new ArchivedSelfImprovementFragment();
                    case 2:
                        return new DeactivatedSelfImprovementFragment();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
