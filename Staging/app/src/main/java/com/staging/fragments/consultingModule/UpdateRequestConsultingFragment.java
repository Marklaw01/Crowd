 ...
 */
public class UpdateRequestConsultingFragment extends Fragment implements onActivityResultListener, View.OnClickListener, AsyncTaskCompleteListener<String> {

    private int document_d = 0;
    private int video_d = 0;
    private int audio_d = 0;
    private int question_d = 0;
    private int finalbid_d = 0;
    private ImageView del_document, del_audio, del_video, del_question, del_finalbid;
    ...
    private EditText et_conditions, et_d_assignment_startdate, et_d_bids_deadlinedate, et_d_questions_dedlinedate, et_d_projectoverview_deadlinedate, et_d_bidderpresentation_deadlinedate, et_d_commitintentbid_deadlinedate, et_d_answers_targetdate, et_d_proposal_deadlinedate, et_d_awardproject_targetdate, et_d_startproject_date, et_d_completeproject_targetdate;
    ...
    public UpdateRequestConsultingFragment() {
        super();
    }
    ...
    public void onResume() {
        ...
        if (viewFiles == true) {
            ...
            if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                ...
                AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.CONSULTING_KEYWORDS_LIST_TAG, Constants.CONSULTING_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                a.execute();
            } else {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        del_question = (ImageView) rootView.findViewById(R.id.del_question);
        del_finalbid = (ImageView) rootView.findViewById(R.id.del_finalbid);
        ...
        searchFocusGroups.setText("Search Recommended Consulting");
        searchFocusGroups.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ConsultingSearchFragment betaTestersSearchFragment = new ConsultingSearchFragment();
        ...
        et_d_assignment_startdate = (EditText) rootView.findViewById(R.id.et_asignment_startdatetime);
        et_d_bids_deadlinedate = (EditText) rootView.findViewById(R.id.et_deadline_datetime_bids);
        et_d_questions_dedlinedate = (EditText) rootView.findViewById(R.id.et_deadline_datetime_questions);
        et_d_projectoverview_deadlinedate = (EditText) rootView.findViewById(R.id.et_deadline_datetime_projectoverview);
        et_d_bidderpresentation_deadlinedate = (EditText) rootView.findViewById(R.id.et_deadline_datetime_bidderpresentation);
        et_d_commitintentbid_deadlinedate = (EditText) rootView.findViewById(R.id.et_deadline_datetime_commitintentbid);
        et_d_answers_targetdate = (EditText) rootView.findViewById(R.id.et_targetdate_foranswers);
        et_d_proposal_deadlinedate = (EditText) rootView.findViewById(R.id.et_deadlinedate_proposals);
        et_d_awardproject_targetdate = (EditText) rootView.findViewById(R.id.et_targetdate_awardproject);
        et_d_startproject_date = (EditText) rootView.findViewById(R.id.et_targetdate_startproject);
        et_d_completeproject_targetdate = (EditText) rootView.findViewById(R.id.et_targetdate_completeproject);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        final String[] choices = {"Document", "Audio", "Video", "Questions", "Final Bid"};
        ...
        spinner_uploadFileType.setAdapter(spinnerArrayAdapter);
        //++++++++++++++++++++++++++++++++++++++++++++
        ...
        et_d_assignment_startdate.setOnClickListener(this);
        et_d_bids_deadlinedate.setOnClickListener(this);
        et_d_questions_dedlinedate.setOnClickListener(this);

        et_d_projectoverview_deadlinedate.setOnClickListener(this);
        et_d_bidderpresentation_deadlinedate.setOnClickListener(this);
        et_d_commitintentbid_deadlinedate.setOnClickListener(this);
        et_d_answers_targetdate.setOnClickListener(this);
        et_d_proposal_deadlinedate.setOnClickListener(this);
        et_d_awardproject_targetdate.setOnClickListener(this);
        et_d_startproject_date.setOnClickListener(this);
        et_d_completeproject_targetdate.setOnClickListener(this);
        ...
        del_question.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                question_d = 1;
                getExpandable_question.setVisibility(View.GONE);
        ...
        del_finalbid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finalbid_d = 1;
                getExpandable_finalbid.setVisibility(View.GONE);
                    ...
                    case Constants.FILE_PICKER:
                        ...
                        if (data.hasExtra(FilePicker.EXTRA_FILE_PATH)) {
                            ...
                            if (length >= Constants.MAX_FILE_LENGTH_ALLOWED) {
                                ...
                                addpath(finalFile.getAbsolutePath(), enteredType, String.valueOf(length), finalFile.getAbsolutePath().substring(a + 1).toString().trim());
                            }
                            //filePath.setText();
                        }
                    break;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit:
                ...
                map.put("interest_keyword_id", selectedInterestedKeywordsId);
                map.put("target_keywords_id", selectedKeywordsIDs);
                map.put("requirement_distribute_date", et_d_assignment_startdate.getText().toString().trim());
                map.put("bid_commitment_deadline_date", et_d_bids_deadlinedate.getText().toString().trim());
                map.put("assignment_start_date", "");
                map.put("assignment_end_time", "");
                map.put("bid_deadline_date", "");
                map.put("question_deadline_date", et_d_questions_dedlinedate.getText().toString().trim());
                map.put("answer_date", "");
                map.put("bidder_presentation_date", et_d_bidderpresentation_deadlinedate.getText().toString().trim());
                map.put("overview", et_conditions.getText().toString().trim());
                map.put("bid_intent_deadline_date", et_d_commitintentbid_deadlinedate.getText().toString().trim());
                map.put("client_overview_date", et_d_projectoverview_deadlinedate.getText().toString().trim());
                map.put("answer_target_date", et_d_answers_targetdate.getText().toString().trim());
                map.put("proposal_submit_date", et_d_proposal_deadlinedate.getText().toString().trim());
                map.put("project_award_date", et_d_awardproject_targetdate.getText().toString().trim());
                map.put("project_start_date", et_d_startproject_date.getText().toString().trim());
                map.put("project_complete_date", et_d_completeproject_targetdate.getText().toString().trim());
                ...
                map.put("question_del", String.valueOf(question_d));
                map.put("final_bid_del", String.valueOf(finalbid_d));
                ...
                if (((HomeActivity) getActivity()).networkConnectivity.isOnline()) {
                    update(map, Constants.UPDATE_CONSULTING_URL);
                } else {
                    ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
                }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            case R.id.et_asignment_startdatetime:
                showTruitonTimePickerDialog(v, et_d_assignment_startdate);
                showTruitonDatePickerDialog(v, et_d_assignment_startdate);
                break;




            case R.id.et_deadline_datetime_bids:

                showTruitonTimePickerDialog(v, et_d_bids_deadlinedate);
                showTruitonDatePickerDialog(v, et_d_bids_deadlinedate);
                break;


            case R.id.et_deadline_datetime_questions:
                showTruitonTimePickerDialog(v, et_d_questions_dedlinedate);
                showTruitonDatePickerDialog(v, et_d_questions_dedlinedate);
                break;




            case R.id.et_deadline_datetime_projectoverview:
                showTruitonTimePickerDialog(v, et_d_projectoverview_deadlinedate);
                showTruitonDatePickerDialog(v, et_d_projectoverview_deadlinedate);
                break;

            case R.id.et_deadline_datetime_bidderpresentation:
                showTruitonTimePickerDialog(v, et_d_bidderpresentation_deadlinedate);
                showTruitonDatePickerDialog(v, et_d_bidderpresentation_deadlinedate);
                break;

            case R.id.et_deadline_datetime_commitintentbid:
                showTruitonTimePickerDialog(v, et_d_commitintentbid_deadlinedate);
                showTruitonDatePickerDialog(v, et_d_commitintentbid_deadlinedate);
                break;

            case R.id.et_targetdate_foranswers:
                showTruitonTimePickerDialog(v, et_d_answers_targetdate);
                showTruitonDatePickerDialog(v, et_d_answers_targetdate);
                break;

            case R.id.et_deadlinedate_proposals:
                showTruitonTimePickerDialog(v, et_d_proposal_deadlinedate);
                showTruitonDatePickerDialog(v, et_d_proposal_deadlinedate);
                break;

            case R.id.et_targetdate_awardproject:
                showTruitonTimePickerDialog(v, et_d_awardproject_targetdate);
                showTruitonDatePickerDialog(v, et_d_awardproject_targetdate);
                break;

            case R.id.et_targetdate_startproject:
                showTruitonTimePickerDialog(v, et_d_startproject_date);
                showTruitonDatePickerDialog(v, et_d_startproject_date);
                break;

            case R.id.et_targetdate_completeproject:
                showTruitonTimePickerDialog(v, et_d_completeproject_targetdate);
                showTruitonDatePickerDialog(v, et_d_completeproject_targetdate);
                break;
                ...
                try {
                    if ((ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) && ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (spinner_uploadFileType.getSelectedItem().toString().trim().equalsIgnoreCase("Document")) {
                            ...
                            enteredType = "video";
                        } else if (spinner_uploadFileType.getSelectedItem().toString().trim().equalsIgnoreCase("Questions")) {
                            acceptedFileExtensions = new String[]{".pdf"};
                            enteredType = "question";
                        } else if (spinner_uploadFileType.getSelectedItem().toString().trim().equalsIgnoreCase("Final Bid")) {
                            acceptedFileExtensions = new String[]{".pdf"};
                            enteredType = "final_bid";
                        }
            ...
            case R.id.btn_plus:
                try {
                    if (layout_more.getChildCount() <= 3) {
                            ...
                            public void onClick(View v) {
                                ...
                                if ((ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) && ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (spinner.getSelectedItem().toString().trim().equalsIgnoreCase("Document")) {
                                        ...
                                        acceptedFileExtensions = new String[]{".mp4"};
                                        enteredType = "video";
                                    } else if (spinner.getSelectedItem().toString().trim().equalsIgnoreCase("Questions")) {
                                        acceptedFileExtensions = new String[]{".pdf"};
                                        enteredType = "question";
                                    } else if (spinner.getSelectedItem().toString().trim().equalsIgnoreCase("Final Bid")) {
                                        acceptedFileExtensions = new String[]{".pdf"};
                                        enteredType = "final_bid";
                                    }
                        ...
                        Toast.makeText(getActivity(), "At a time only 5 files can be uploaded!", Toast.LENGTH_LONG).show();
                    }
                    browseid++;
                    deleteId++;
                } catch (Exception e) {
    ...
    public void onTaskComplete(String result, String tag) {
        if (result.equalsIgnoreCase(Constants.NOINTERNET)) {
            ...
            if (tag.equals(Constants.CONSULTING_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    keywordsList.clear();
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        for (int i = 0; i < jsonObject.optJSONArray("target_keyword_list").length(); i++) {
                            GenericObject obj = new GenericObject();
                            obj.setId(jsonObject.optJSONArray("target_keyword_list").getJSONObject(i).optString("id"));
                            obj.setTitle(jsonObject.optJSONArray("target_keyword_list").getJSONObject(i).optString("name"));
                            obj.setPosition(i);
                            keywordsList.add(obj);
                        }
                        if (((HomeActivity) getActivity()).networkConnectivity.isInternetConnectionAvaliable()) {
                            AsyncNew a = new AsyncNew(getActivity(), (AsyncTaskCompleteListener<String>) getActivity(), Constants.CONSULTING_INTEREST_KEYWORDS_LIST_TAG, Constants.CONSULTING_INTEREST_KEYWORDS_LIST_URL, Constants.HTTP_GET_REQUEST, null);
                            a.execute();
                        } else {
                            ((HomeActivity) getActivity()).dismissProgressDialog();
                            ((HomeActivity) getActivity()).utilitiesClass.alertDialogSingleButton(getString(R.string.no_internet_connection));
            ...
            } else if (tag.equals(Constants.CONSULTING_INTEREST_KEYWORDS_LIST_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
            ...
            } else if (tag.equals(Constants.CONSULTING_DETAILS_TAG)) {
                CrowdBootstrapLogger.logInfo(result);
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    ...
                    if (jsonObject.optString(Constants.RESPONSE_STATUS_CODE).equalsIgnoreCase(Constants.RESPONSE_SUCESS_STATUS_CODE)) {
                        ...
                        et_d_assignment_startdate.setText(jsonObject.getString("requirement_distribute_date"));
                        et_d_commitintentbid_deadlinedate.setText(jsonObject.getString("bid_intent_deadline_date"));
                        et_d_bids_deadlinedate.setText(jsonObject.getString("bid_commitment_deadline_date"));
                        et_d_questions_dedlinedate.setText(jsonObject.getString("question_deadline_date"));

                        et_conditions.setText(jsonObject.getString("overview"));
                        et_d_bidderpresentation_deadlinedate.setText(jsonObject.getString("bidder_presentation_date"));

                        et_d_projectoverview_deadlinedate.setText(jsonObject.getString("client_overview_date"));
                        et_d_answers_targetdate.setText(jsonObject.getString("answer_target_date"));
                        et_d_proposal_deadlinedate.setText(jsonObject.getString("proposal_submit_date"));
                        et_d_awardproject_targetdate.setText(jsonObject.getString("project_award_date"));
                        et_d_startproject_date.setText(jsonObject.getString("project_start_date"));
                        et_d_completeproject_targetdate.setText(jsonObject.getString("project_complete_date"));
                        ...
                        //fund managers
                        preChecked(jsonObject.getJSONArray("interest_keyword_id"), interestedKeywordsList, R.id.et_interestKeywords);


                        //fund sponsors
                        preChecked(jsonObject.getJSONArray("target_keywords_id"), keywordsList, R.id.et_keywords);
                    ...
                    try {
                       /* ArrayList<File> files = new ArrayList<File>();
                        ...
                        for (int i = 0; i < pathofmedia.size(); i++) {
                            ...
                            if (pathofmedia.get(i).getPath().contains(".pdf") && (pathofmedia.get(i).getType().compareTo("question") == 0)) {
                                questionFile = (new File(pathofmedia.get(i).getPath()));
                            }
                            if (pathofmedia.get(i).getPath().contains(".pdf") && (pathofmedia.get(i).getType().compareTo("final_bid") == 0)) {
                                finalbidFile = (new File(pathofmedia.get(i).getPath()));
                            }
                        ...
                        if (questionFile != null) {
                            questionFileBody = new FileBody(questionFile);
                        }
                        if (finalbidFile != null) {
                            finalbidFileBody = new FileBody(finalbidFile);
                        }
                        ...
                        if (bitmap != null) {
                            ...
                            if (questionFileBody != null) {
                                entity.addPart("question", questionFileBody);
                            }
                            if (finalbidFileBody != null) {
                                entity.addPart("final_bid", finalbidFileBody);
                            }
...
//        int finalHeight = expandable_playVideo.getHeight();
    ...
    // COLLECTIVE DATE TIME PICKER


    public void showTruitonDatePickerDialog(View v, EditText DateEdit) {
        DialogFragment newFragment = new DatePickerFragment(DateEdit);
    ...
    public static class DatePickerFragment extends DialogFragment implements
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            ...
            try {
                ...
                SimpleDateFormat sdfNew = new SimpleDateFormat(Constants.DATE_FORMAT, Locale.US);

                DateEdit.setText(sdfNew.format(date));
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void showTruitonTimePickerDialog(View v, EditText DateEdit) {
        DialogFragment newFragment = new TimePickerFragment(DateEdit);
    ...
    public static class TimePickerFragment extends DialogFragment implements
        ...
        public TimePickerFragment(EditText dateEdit) {
            this.DateEdit = dateEdit;
        }
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            try {
                ...
                SimpleDateFormat sdfNew = new SimpleDateFormat(Constants.TIME_FORMAT, Locale.US);

                DateEdit.setText(DateEdit.getText() + ", " + sdfNew.format(time));
            } catch (Exception e) {
                e.printStackTrace();
            }
