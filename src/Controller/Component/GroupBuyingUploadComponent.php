...
class GroupBuyingUploadComponent extends Component
{
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('GroupBuyingInterestKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('GroupBuyingKeywords');
		...
		* * * * */
		...
		{
			$JobPostingKeywords = TableRegistry::get('GroupBuyingTargetMarkets');
		...
		* * * * */
		public function isFollowedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('GroupBuyingFollowers');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['groupbuying_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function isCommitedbyUser($fundId=null,$userId=null)
		{
			...
			$FundFollowers = TableRegistry::get('GroupBuyingCommitments');
			$FundFollower= $FundFollowers->find('all',['conditions'=>['groupbuying_id' => $fundId,'user_id' => $userId]])->first();
		...
		* * * * */
		public function getCommitCount($fundId=null)
		{
			...
			$FundDislikes = TableRegistry::get('GroupBuyingCommitments');
			$likelists= $FundDislikes->find('all',['conditions'=>['groupbuying_id' => $fundId]]);
	    ...
	    ****/
	    ...
	    public function uploadImage($files = null) 
	    {
		    ...
		    if(!empty($files)){
                ...
                $path = WWW_ROOT . "img/groupbuying/"; // Upload directory
                $imgCamp='';
                $errors='';
