...
use App\Model\Entity\EntrepreneurBasic;
use Cake\ORM\Query;
use Cake\ORM\RulesChecker;
use Cake\ORM\Table;
use Cake\Validation\Validator;

class EntrepreneurBasicsTable extends Table
{
    public function initialize(array $config)
    {
         parent::initialize($config);
         $this->addBehavior('Timestamp');
         $this->table('entrepreneur_basics');
        ...
        public function validationDefault(Validator $validator)
    {
        $validator
            ...
            /*->add('bio','custom',[
                ...
                'message'=>'Bio has invalid characters!',
            ]);*/
       ...
       /* $validator
        ...
        $validator
            ->requirePresence('my_interests')
            ->allowEmpty('my_interests');
            /*->add('my_interests','custom',[
                'rule' => function($value){
                            if ($value) {
                                if (!preg_match("/^[\r\na-zA-Z0-9!@#$%^~&*()||.+=_\/-:,;?\-<>\'\"\\\\ ]+$/i", $value)) {
                                    return false;
                ...
                'message'=>'My Interests has invalid characters!',
            ]);*/
